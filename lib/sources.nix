{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-tcl" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-N7G2fPyoWkGzjFDdzuTOcR6XE22QYPoLtaNZij1EUiU=";
    };
  };
  "tree-sitter-teal" = {
    version = "0.0.4";
  ...
  "tree-sitter-zscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "243462969008a85145e014dc89495175346ae77b";
      hash = "sha256-HlklhLz37p/HG54yoWUufn3H5XtS41yupHz4zJXto1c=";
    };
  };
  "tree-sitter-zsh" = {
