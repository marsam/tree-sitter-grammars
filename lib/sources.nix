{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-kos" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ff4b3c4115cbdd380f8c23556559cddd51946f77";
      hash = "sha256-YnuqfFj/xwFd3BXcII0eRDMQ2J0CBo93zlPxVjknwAU=";
    };
  };
  "tree-sitter-kotlin" = {
    version = "0.3.8";
  ...
  "tree-sitter-objectscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "4d34cb2d4a4924f0b9c9524ffaba1b9c0644067e";
      hash = "sha256-4lIDSa2ZKWBRBEcVXoVn8LM1YVysyo5wf+wbyOP4NJ0=";
    };
  };
