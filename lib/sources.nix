{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-caddyfile" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "3ab80983d42b846378a1d8857b76e8c0a3f137a3";
      hash = "sha256-ns+l1vgZAaaEzV4dVfBC6quIHeDpKLiVvZivm3kvT+o=";
    };
  };
  "tree-sitter-cairo" = {
    version = "1.0.0";
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "92978bece9b9790fe13c97a44eb0d07da23a90e2";
      hash = "sha256-XqztM5PhBpAA4GKy1U6k8i49Rg/bmDhkE9DAVtz7/O0=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "dda577d8cc3c5ae4b1f6cf65a4744b42e8d6ce33";
      hash = "sha256-K3ml3yXGjqK4S8WmnEDGklGZuBcqIBkKD7qnpgB0/Io=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
