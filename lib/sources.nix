{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.26.22";
      hash = "sha256-SJY4Zx7pK09F+uHr9qmPaqm0CVJQY5/xOdcGmoCLmvQ=";
    };
  };
  "tree-sitter-cgsql" = {
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "de21e92b02ed87b02f272495f9dd5fbbb18a597b";
      hash = "sha256-5nF81+fJvrYEBT5wNTMbrVhTGiR+58LKJ+zPcxQadpU=";
    };
  };
  "tree-sitter-ledger" = {
    version = "unstable-2026-03-20";
