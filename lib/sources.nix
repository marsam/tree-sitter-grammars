{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-al";
      rev = "v2.5.1-shim";
      hash = "sha256-MJiGYSXyDq483CNfChlS7IGlgiQ2S1W3vmxzxrVS/u8=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.26.12";
      hash = "sha256-ZdNq+SJVDI4/Zq+XplAe6UaS+8XTmtiP9wYnLEMIa/A=";
    };
  };
  "tree-sitter-cgsql" = {
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "d7fa499954b4327058bc1b8deb35947530b2b05c";
      hash = "sha256-MgW8RmKWbQaTj+dxGNzM2g4x3qJAyFkjaQM7x0O6jxA=";
    };
  };
  "tree-sitter-ledger" = {
    version = "unstable-2026-03-20";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2026.5.14";
      hash = "sha256-NM33dwGgJG1IPSggVnY/brKK/k25fe2nyWUqs+NoLsU=";
    };
  };
