{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-fodot" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "71f7709441f746bf1e0770ae5c02d7373e30a469";
      hash = "sha256-ZSbXErki2DlevdPV5X+NxuJc7RQi4uSAv+hhdbX8r/U=";
    };
  };
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "9ab7836ca440dc279ec9ae1962aae4dfccf5cdc5";
      hash = "sha256-bu4eXnbRofMCUQ5d2fsymcZzcIcf4Md5s9aWMhEKT7o=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-matlab" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.1.1";
      hash = "sha256-RoNncJVefBvu/CWMHMux2vOhZBYFQ7jQ3rvFrGbl1QQ=";
    };
  };
  "tree-sitter-mcfuncx" = {
  ...
  "tree-sitter-skbdrc" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "794b19a0401e160227b4f5d134143cb014532eac";
      hash = "sha256-3q70YMuKICsu2h6JGbKApSxjrXI+tE4RInER6Ra/wKM=";
    };
  };
  "tree-sitter-slang" = {
    version = "0.3.1";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "aeab8142139a24439536b44938b10aa6dbfc2112";
      hash = "sha256-2mfYIZmC0IG4x8HTjAU4Gfx4T/ctTZ9hY+zIBhQDqr0=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.8.21";
      hash = "sha256-0+2L1C0H1wCc3VCs5vk8CwqIPwmmeLGCb+gA8D9fqWU=";
    };
  };
