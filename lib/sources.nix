{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-jai" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "8407cfa3997bbc6dcfddf375e08d5ac3935a681b";
      hash = "sha256-+gvYRsqGKUCjN23yuGIi031HxKgyKPUpVreeyDvz8Bk=";
    };
  };
  "tree-sitter-jakt" = {
  ...
  "tree-sitter-pgn" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.2.19";
      hash = "sha256-GhxpDFL/W5OjPOlcesdPQCTmNy7r0QgFY3murEqknWI=";
    };
  };
  "tree-sitter-phpdoc" = {
    version = "0.1.6";
