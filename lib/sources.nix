{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-catala_en" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "773af2b992077c050c9eecc327ded8035aba9a93";
      hash = "sha256-pRNkuRi0hn6dAjO+HsZa7Wh3RWkurukfd6yrX25QBEA=";
    };
  };
  "tree-sitter-cds" = {
    version = "1.0.0";
  ...
  "tree-sitter-datazinc" = {
    ...
    src = fetchFromGitHub {
      owner = "shackle-rs";
      repo = "shackle";
      rev = "1bfb28e3696818b5382cd4735aaf166e2237d73c";
      hash = "sha256-ntpc/cDq0TcMYTCSgMkoJMx3D5RoAO6naco17jexqww=";
    };
  };
  "tree-sitter-dbml" = {
    version = "0.1.0";
  ...
  "tree-sitter-fodot" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "2c43516cb228479d3e669c11787e76bd62e733ca";
      hash = "sha256-Rjjc0poCV1zMEEthveJXJVwh56U5MlsOQyUkTkZsRSs=";
    };
  };
  ...
  "tree-sitter-gram" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.2.0";
      hash = "sha256-TFiJxylBdwbxlGulacbNok5JPlltL2aX0zHTUewagyQ=";
    };
  };
  "tree-sitter-graphql" = {
  ...
  "tree-sitter-jai" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a73dd2be5dfca88e91e1c4c5229c18769ab7dac7";
      hash = "sha256-NwKX7sj9S2QDe8CDbkkHCHabWaF4y7qCgFgKj0/0Hh4=";
    };
  };
  "tree-sitter-jakt" = {
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "de25947d9aac772a67566ed3cec7571e4fba9f17";
      hash = "sha256-PNh3smhuJw2BzVO1QZfOmnIoskQenai52i75oV7OQUg=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-matlab" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.2.6";
      hash = "sha256-wKI/BufSB1HoEP+CqKCrWtfIbh347am7V4hLBA8ogbg=";
    };
  };
  "tree-sitter-mcfuncx" = {
  ...
  "tree-sitter-mips" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.2.0";
      hash = "sha256-UDnx/EboozgP1RLiihK37edPtDgSiXi0LVxNlM4gSkU=";
    };
  };
  "tree-sitter-mlir" = {
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "70506342983840099df3d76ab9e20af713e6d1b1";
      hash = "sha256-a/Z2zCEPUHpzj4NtCq7ZTBStp3M22aDfrsbCWf5zQrc=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.11";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "25ffe505fd034e53007daf432d6f84df0e810258";
      hash = "sha256-lMvAjIU9LXGJYNhyjFk35cgwlkJmgr944zUO9PlbbcU=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-structurizr" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "7a29c74bd18b763d86c919d74a2f730e3c341666";
      hash = "sha256-U9P1taK4jygtyHXNie1wAjnqTeple4lwDRpolbz17ME=";
    };
  };
  "tree-sitter-styled" = {
  ...
  "tree-sitter-sus" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "sus-compiler";
      rev = "v0.3.5";
      hash = "sha256-RgNzW+zkBCK9LILQZPgyAFUiyPSeCHEr3snxzMkJMi4=";
    };
  };
  "tree-sitter-svelte" = {
    version = "1.0.2";
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "7ba73b05ac22b95ff9f14e0ab4883d02044669af";
      hash = "sha256-IaprHPDLIr1DmiSdkRL0IEXKP8K+W21gH27uAh6bb74=";
    };
  };
  "tree-sitter-tl" = {
