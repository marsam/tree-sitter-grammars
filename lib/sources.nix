{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "724b0fee7b056a873b1e04dc5e1b0da05d6d9b4f";
      hash = "sha256-3U5scz2z6JjjOGC9dl7GYMM0IPG4j5042AwfQWLvnLc=";
    };
  };
  "tree-sitter-ledger" = {
    version = "unstable-2026-03-20";
  ...
  "tree-sitter-perl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.1.0";
      hash = "sha256-8qKc5WG+8iHFXQhppWAMKye01qtc3QLeDQ2EwWTNl3M=";
    };
  };
  "tree-sitter-perm" = {
    version = "0.0.1";
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f4b985f09f526c884281af51277f2e13fdcda028";
      hash = "sha256-9vO3ZjRsu7Cs5FkR7LLS0NxZ0gFtpR+4Q1I8JzZnIwQ=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.11";
