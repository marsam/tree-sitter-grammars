{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-esl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e8a7228b106911d7ce92ba486c782fb366895f25";
      hash = "sha256-JRVUn69qDNEVhnj4nf3Nd/a0ObFywsPylaE9TIZtk00=";
    };
  };
  "tree-sitter-eu4mod" = {
    version = "1.0.3";
  ...
  "tree-sitter-lilypond" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-gjuUOqPVRDoTLYaN/Brq3/n+sHPGqUuHGQewk682Jj4=";
    };
  };
  ...
  "tree-sitter-npf" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5ea9269442d8cace201bc7fb87ff454b9b914bde";
      hash = "sha256-Um0Jkv0Mb2Antj5wrHMw429zRwrAmsKJM0jM0vxheX4=";
    };
  };
  "tree-sitter-nqc" = {
    version = "1.0.0";
