{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      owner = "SShadowS";
      repo = "tree-sitter-al";
      rev = "1821962a32d802810da424f46943ae239b61ac68";
      hash = "sha256-CyyiixKF2xiJjwXtrKzw1yhWPdAovglJa8C99Iue7V0=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-caddyfile" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6190cb7de14c8e3c3d9782bc44f46370a5481b18";
      hash = "sha256-/pMUX6nR3JsoHlc+RSjQC8Y4awEEKvoAHrFR6LLdvYI=";
    };
  };
  "tree-sitter-cairo" = {
    version = "1.0.0";
  ...
  "tree-sitter-csound" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6d5f7214cf27955e2120873d006a13dda899c688";
      hash = "sha256-fx5qYm7/cDApQE9c6uALOkCp8pFjBvrReyOIZMZ81BM=";
    };
  };
  ...
  "tree-sitter-hy" = {
    ...
    src = fetchFromGitHub {
      owner = "MinmusxMinmus";
      repo = "tree-sitter-hy";
      rev = "cd4a7197ee20a14edef02fdf51bba381886dd031";
      hash = "sha256-2NqX/Rvn06Pl6tRWCBzoQLbGSmqUBhCr1y0CmPRRULQ=";
    };
  };
  ...
  "tree-sitter-ignis" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "7c2eb3955e139795c6269c90ce4816de86720691";
      hash = "sha256-M0hRs5100CgtsqX3tFxx69w5ZMpxdFoUVl/P5n8NQb4=";
    };
  };
  "tree-sitter-ini" = {
    version = "1.4.0";
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "dd83de2cdd17e28c07f7f0c9159667c07a44a8e2";
      hash = "sha256-LM7AGGXgZ9x/aSFdyy8rjOJFB2GNMdSoPAvSVn9qnF8=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-matlab" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.2.13";
      hash = "sha256-946j40nbFHb/FgmtGv/NQDV6RIgkp2VuvC24tWViYUI=";
    };
  };
  "tree-sitter-mcfuncx" = {
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "747a4356e24a4caeff4948e4f08ee5280da55939";
      hash = "sha256-NmUB4hVIMUrXWgITgORTaFytktXmk+FKoDzClODjsOE=";
    };
  };
  "tree-sitter-mojo" = {
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "28596c53e9bea464d05ef606deeee065e95a2665";
      hash = "sha256-0NJ+LJouhcnwbnk2tj0P9NqWmAkGwP0QMGQTc75OpuY=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-rpmspec" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "ddb6084ce8472af0dbef99368389c8e69e48a688";
      hash = "sha256-23LmCGTXUm6eA5WTUlIDG2FxgfDy7pw8EXntw+XL3hs=";
    };
  };
  "tree-sitter-rslox" = {
    version = "0.1.1";
  ...
  "tree-sitter-slint" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "9b7b9416cddb46769745594c536e7673cc5e7121";
      hash = "sha256-S7sfbx73swdwjtBfrQidOxpCneaomyrOCn3feCjEzC0=";
    };
  };
  "tree-sitter-smali" = {
    version = "1.0.0";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "85150dfaf0eb247d912f3beaa2b0fa1cca063dab";
      hash = "sha256-YLsKV+F63aV1jl+xfZwwVnuxen5j/MjqWx18vRE0CZA=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "33dd5b6a07e20c3f4509d8f1d00e48912c91e2d4";
      hash = "sha256-+qRk9aq6UKHvqXPK/7MjBAoeJTOdaobYBcTQqdWJHKA=";
    };
  };
  "tree-sitter-tl" = {
