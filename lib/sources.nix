{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-al";
      rev = "v2.5.2-shim";
      hash = "sha256-EpBBDrERcVrXiW3lCFmS1uutXI2RGws2LTMogUWSoWM=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-fodot" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "c182de6d46dc738e34afd34764b0aef482a99f74";
      hash = "sha256-amvzWOiBvScprrTai0AINKbD1ya/BuRgp/U+/afvx00=";
    };
  };
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5255dc53a4e4f423f1978018ab430b6f9100f645";
      hash = "sha256-QoYiBr6Jr0Ysk27xfnX22DPiCN1A2Xec/Fi4cSmK9+c=";
    };
  };
  "tree-sitter-ledger" = {
    version = "unstable-2026-03-20";
  ...
  "tree-sitter-lispbm" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f843f23c9d030219e48c245758818e45a03a05be";
      hash = "sha256-0XxTxiCRoPV/AApLsOmeNTFymZE1BKrNfUVY7EtVj6E=";
    };
  };
  "tree-sitter-llvm" = {
    version = "1.1.0";
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a116c4a11ea023ea428b386fd2283587f662cebc";
      hash = "sha256-s0k+4u6ibTHXVa1l0OXQVPe/YFYCTl8ir+MEcJuuNYQ=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.11";
