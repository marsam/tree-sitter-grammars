{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-chuck" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f73b5ffe8639258aba05cc00a0874bc5ba031e19";
      hash = "sha256-P3PcKYkRvMjg6n3OG5wSYwKXm60UJ5gGvpVEnBrKUZE=";
    };
  };
  "tree-sitter-circom" = {
  ...
  "tree-sitter-nu" = {
    ...
    src = fetchFromGitHub {
      owner = "nushell";
      repo = "tree-sitter-nu";
      rev = "f1cbfb01173d5088e0e65df4eed8d7edd04ee310";
      hash = "sha256-jeIjdXi2Y9CsC4kV7x6vBT22zARwTEoemBOfZ9xIQnI=";
    };
  };
  "tree-sitter-numbat" = {
    version = "unstable-2024-04-04";
