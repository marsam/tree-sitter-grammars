{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.26.34";
      hash = "sha256-QPOxN8GHP8SLbNy2Yd7HBJ+u7pwUZCs8ggrzOOCzroc=";
    };
  };
  "tree-sitter-cgsql" = {
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f3096093a6c791cc3b11ee7fa2872e22f1ebf30c";
      hash = "sha256-v6B5V3smf9f6v7YKnqbQ/Af/H5mHrNf/zrSzPNvzm/U=";
    };
  };
  "tree-sitter-ledger" = {
