{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-esl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ec20e57334405d7c0a8ab1035de3d77466e2f53b";
      hash = "sha256-GRy8dkbaxTN050YczRcpXrXeig7WHsUREcqvUlVzkj0=";
    };
  };
  "tree-sitter-eu4mod" = {
    version = "1.0.3";
  ...
  "tree-sitter-q" = {
    ...
    src = fetchFromGitHub {
      owner = "Gchouchou";
      repo = "tree-sitter-q";
      rev = "37826b832828a131ff52711364028c47c6e5e1b3";
      hash = "sha256-ttu+ndrwKvrlQQGzeZLA90B/qltAgpALeZT9TX/Mxsg=";
    };
  };
  "tree-sitter-qmldir" = {
    version = "0.2.2";
