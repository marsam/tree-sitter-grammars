{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-abl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.0.50";
      hash = "sha256-PW7E1nLY4SVLaEXOVcnn06gK5HV7Sd7pih3Z/J+kFJ8=";
    };
  };
  "tree-sitter-abnf" = {
    version = "1.0.0";
  ...
  "tree-sitter-caddyfile" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f8086016343af2844dab0ecb6112f4171f4239b9";
      hash = "sha256-FR1q+zqSKCsTWW1oIHnXePcrIGXYsGGG+V7olcyJgAM=";
    };
  };
  "tree-sitter-cairo" = {
    version = "1.0.0";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "031e5c10c7165bddb172801915bf70fd5eb97b5f";
      hash = "sha256-Id3z70vMnamoMAklkFrGiLoO2irKD4RrAt5/1ZSW7wc=";
    };
  };
  "tree-sitter-mojo" = {
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-p0yLwTT/PnE3sJ33aqOn+arfS+RI0jLjp5PpMGli24A=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-rpmspec" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "12ca6187e144648d0cbe287dcc75f0fdd878a9ac";
      hash = "sha256-U0kziw8kLssMxOzcSix3C+hB3kLaR3f5H64+3hoJ/QQ=";
    };
  };
  "tree-sitter-rslox" = {
    version = "0.1.1";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "873646d133e0743125a183a38f258494367ee43d";
      hash = "sha256-ZrJX0ZVFkqu+Zgcl/NkAhCM/Yw87b3j5edPJgs+/mk0=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
