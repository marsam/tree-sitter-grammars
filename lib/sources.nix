{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-fodot" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "d485e85c67ca1886ea102ecfc7afbaa663198cfc";
      hash = "sha256-c9SmtSViSlXEBQ9tSZey5wSV2J3fGahPkcAAhq60BWU=";
    };
  };
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "15c50c05eb1a7338f2d11f787d0b64ff4052b80d";
      hash = "sha256-DihxrOPtuuB4262DjxdBirZkId5YLz001T3unmGT0Vo=";
    };
  };
  "tree-sitter-ledger" = {
    version = "unstable-2026-03-20";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "40ed63e398b75991e3c9fa32b9d88f44a93e4994";
      hash = "sha256-8WX8bCrFEV5VW86Pz04cJfiQTpXLMXNuihV/ej0tdG8=";
    };
  };
  "tree-sitter-mojo" = {
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "455801b779e9c01b0cd66e5f2212fd771be4d338";
      hash = "sha256-DlBG4w+4rWUviy4Zef/qTEyS1wN6HsiX0yzlsPujbFQ=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.11";
