{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "56753db408dbcc098e514c73cbb2351d344039e0";
      hash = "sha256-OoFjNBdX/d2OLcbT1Tcw5m8YR2ek2LnaapCOWfVXEkQ=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a77dd3b9893497c2cfb7055735f797eaa81c638c";
      hash = "sha256-FsVKTQ/72LPG6kfcOhNwfbzleTifVXeS57QI1W9ZVk0=";
    };
  };
  ...
  "tree-sitter-nelua" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "170806d84f0791e1911ecbf2daa9999ae55e8826";
      hash = "sha256-zvhPSF2f3VTQOyGnMPxeWArxBEToxIj9IbcHBOweb6o=";
    };
  };
  "tree-sitter-nesfab" = {
  ...
  "tree-sitter-octizys" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "4dce1a976c79d9bb1a767d9280fc7220b2cb563d";
      hash = "sha256-RAth7Q+vI+8ky4QKFzfTB+cnnbhwXJX3urumyOMREzQ=";
    };
  };
  "tree-sitter-odin" = {
    version = "1.3.0";
