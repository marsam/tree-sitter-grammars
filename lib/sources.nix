{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-gritql" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-yX5lxthEG/LemQwAc0q5yeEOPdecaclxIQ7yswFIJvA=";
    };
  };
  "tree-sitter-groovy" = {
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1f37ba41993b3eeb24fb8ec02a246544a41da718";
      hash = "sha256-mRX4xnlMgVRIACQ4iRmZjmwkzW8Ix+I4TcDm6PCzGJc=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.10.2";
      hash = "sha256-QocO9Zx0iiw4iJ8MamD4tLl/1riRMlW4OjtczvTZPtU=";
    };
  };
