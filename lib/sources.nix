{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-catala_en" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5f953afd71ba54b5d57189d7aac7a684f97c519c";
      hash = "sha256-yaKoa2C8RjGT8gxKD1RutY9XSaEjDxRyvyMMrKyffOY=";
    };
  };
  "tree-sitter-cds" = {
    version = "1.0.0";
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "824826b23fa68561489e9b63fbfbb4ce6dd258c7";
      hash = "sha256-X5ZX3Nw6LjmOBFeOwgyKzbduuKruzSC1fGb1WzLo6RM=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-mers" = {
    ...
    src = fetchFromGitHub {
      owner = "Dummi26";
      repo = "mers";
      rev = "ffcd95c72de92970a3365e786e0e51ad885b904c";
      hash = "sha256-sjq12kX59sVWdfoWo07qPDyhroBNyg17RQLwpFrH5NU=";
    };
  };
  "tree-sitter-meson" = {
    version = "1.3.0";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "3eaa817df1aed05354fbd36ef097047a30d4dddf";
      hash = "sha256-+yedCYkSyoFznjnPQcnHM6Sr+vqJnCfmEBLU+M52qoE=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
