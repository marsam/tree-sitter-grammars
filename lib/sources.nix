{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-enforce" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.3.1";
      hash = "sha256-E9Pk2sGDhkTkIfs9UnEGKeFLIxvyF1a8FpzrUzhKLWw=";
    };
  };
  "tree-sitter-envy" = {
  ...
  "tree-sitter-jasmin" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0046df37f35d949efe35aaf30b38a2ee91c1d1a9";
      hash = "sha256-jY7Beef3t7iR9ABLNlYE8bCE/wcAHfo4XLp9wl3w2Bc=";
    };
  };
  "tree-sitter-javadoc" = {
    version = "0.2.4";
  ...
  "tree-sitter-vcard" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.2.0";
      hash = "sha256-e9riDnrww371zevgTKXz98ufGVxV11PZj90mLDAEqEA=";
    };
  };
  "tree-sitter-vento" = {
