{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-caddyfile" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a8669017cb7b3e600dfc1346d11d0943bfd47bf3";
      hash = "sha256-PTpoW4YQWC6+KhbGglHevGSXL/4OL+jifAApWl1Piag=";
    };
  };
  "tree-sitter-cairo" = {
    version = "1.0.0";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6b076cee4c99296cf10923b51a1eaa7f21b2834c";
      hash = "sha256-wadTrhHn1BV8HX4hjOFhMJg8HrIg2Td35NdQkvKi4O4=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
