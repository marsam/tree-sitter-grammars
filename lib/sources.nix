{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-al";
      rev = "v2.5.2";
      hash = "sha256-4KfHSRfcrIG5jq6cng+jsO+KZCBiPOi2rzkwVYvNkc8=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6a4a622b53b7424d7fb1bbc500ca5a3b7e4d3532";
      hash = "sha256-JPsJZkDd7HGnT0dZsUDM/WnXTF96EzZh4FcpPk4BR3g=";
    };
  };
  "tree-sitter-ledger" = {
    version = "unstable-2026-03-20";
