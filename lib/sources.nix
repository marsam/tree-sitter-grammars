{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "9e3291090876d21ebe7eaedec26c9854fe8aa4d8";
      hash = "sha256-W0joLuiDY1fZ7mMnxqINmX3Wus5oWQt0KuWCz/T5gfY=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "af5c2a46a8319dfd82688dcd1e1c572dbf842fb7";
      hash = "sha256-ne1OShQf9KKvQqQ4MDxN0S8KBb5XxvJFhcaz9kQtd9k=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ebcd6ec2b2d1f89056a1a8d7e07ab933391d9392";
      hash = "sha256-HT8C/DBvu7GREtEGQ90O3UxFKttc5Vq7v7K8FftYM7M=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.9.4";
      hash = "sha256-oqE2gmTtRB5JQWfgQPZg1SFFpJwn7q8NjxT1Kb1bN/w=";
    };
  };
