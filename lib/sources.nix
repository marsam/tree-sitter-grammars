{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-crystal" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2947333cf7d47ce842e8df70c709deb51ee86ae5";
      hash = "sha256-98hDMsOsyltx2kJLfDlKJDtw9YVSpjp+LiEQwfPoneY=";
    };
  };
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-sJpP9vY0nh29WZmpBaO+O+k/jZSB4jduKTy0XTq7Pos=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5e6e3df4694fa9a3411089192d195c7bacb7e878";
      hash = "sha256-ypIVjt5xPMTa4mSnpW7+ZkxMEAlG5wb8kzzskt/2lr0=";
    };
  };
  ...
  "tree-sitter-skbdrc" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "b005cff970f2b7dcb26fce9994d1a34fa6c72000";
      hash = "sha256-BeZnBSepj7zNavjXW+IZkrbT0vP9Jv42K5utAqvy1kI=";
    };
  };
  "tree-sitter-slang" = {
    version = "0.2.3";
  ...
  "tree-sitter-sus" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-xFyOHJ/QmRkElPzEx2BN6vRYokUrp8RbUSy66cmXzag=";
    };
  };
  "tree-sitter-svelte" = {
    version = "1.0.2";
