{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-ocaml" = {
    version = "0.25.0-abi14";
    src = fetchFromGitHub {
      owner = "tree-sitter";
      repo = "tree-sitter-ocaml";
      rev = "v0.25.0-abi14";
      hash = "sha256-qWnwNAQKUCbS7LVJd+Qqj8gQb+mogXzaASXp7VHgceU=";
    };
  };
  "tree-sitter-php" = {
    version = "0.24.2";
  ...
  "tree-sitter-abl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.0.52";
      hash = "sha256-XtM/UNBOMG2IDnyhzlfIpAu1rX0coVuqR2PFm4VFpJw=";
    };
  };
  "tree-sitter-abnf" = {
    version = "1.0.0";
  ...
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.26.33";
      hash = "sha256-G5jB9A4hpkq49u62l2lO/sWPilglhDFX4GBV5BhUIY0=";
    };
  };
  "tree-sitter-cgsql" = {
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e2c8b8f95438a50c81985e6e77d303b480b4159c";
      hash = "sha256-U3udpnNiYpWQTac6z7w14kYoqE599xsjdpmUxFrMqB8=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "30e83c66a01a7d30c570bbd4809771de71e8acd0";
      hash = "sha256-keBxxOjkCzCAptkxrEVMJW5ICyzU2f6MbJs805SCb7I=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2026-08-20";
    src = fetchFromGitHub {
      ...
      rev = "b3dbc3525ab650543e222025fc76122f086ab8ec";
      hash = "sha256-yf8zqK9QQ8AKAExHsLOz6M5rIbqiRE0aW52NGLUuMZI=";
    };
  };
  "tree-sitter-moonbit" = {
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2f9c5e2ac4994c2d9e7308af783e97df94020094";
      hash = "sha256-BEJtLLtY9P79zidKlj6pFLETNF1adrugi9uim1hJkH8=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.12";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "8c70f4ba981eddf49b82ea5e1507379081c9080f";
      hash = "sha256-Ssr6zU0xuD5drwl8tUl4uTFXL31/Nm3onDvP+Hv9zZk=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-surrealql" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5b98402dddbc3edfb85d8f555640b33166b71e62";
      hash = "sha256-pCGgc/84/CHtLNLwzc7jCE0rgRyGgm/hZA3zd6Wsl7Y=";
    };
  };
  "tree-sitter-sus" = {
    version = "0.5.0";
