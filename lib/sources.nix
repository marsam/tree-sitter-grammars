{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-6K/5WWqTeaqQXfCYujWS7CVikPn6dhHxusTh1vOt4Dg=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-systemverilog" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-tU6bXZEcZf4WAFpm1uVA1y56MqUa2MGWBQ+qcruLW1Y=";
    };
  };
  "tree-sitter-t32" = {
    version = "5.4.1";
  ...
  "tree-sitter-tera" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-jXNyY55GTAFj5HtA74P65zwyN3mR66Kyp+nJ3vZzyVU=";
    };
  };
  "tree-sitter-test" = {
    version = "0.1.0";
