{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-php" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.24.0";
      hash = "sha256-KdRVD6+yGcjKFFWvmAb/wZivTn+Y2vzzIsFgMBWZMUo=";
    };
  };
  "tree-sitter-python" = {
    version = "0.23.6";
  ...
  "tree-sitter-datazinc" = {
    ...
    src = fetchFromGitHub {
      owner = "shackle-rs";
      repo = "shackle";
      rev = "68456ca62e0fc57c25fa2a412a933674679233fd";
      hash = "sha256-QXO3VPbFjRSl7+Nf2gi6UOHQfD3WZkulqCwZXipk9V0=";
    };
  };
  "tree-sitter-dbml" = {
    version = "0.1.0";
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "374e708dc9d2fec48839d71972d5332c162ab31b";
      hash = "sha256-QNqvW5TzmnvC8epGn84EtOVI3da+6qkm5ylqX11yZ+c=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-gularen" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "b6ee247b092308ce87e923d046d42c36d00e34b2";
      hash = "sha256-AV3sNUH4Z9ST66CUvCPkz7MsLERIW1TQJw4qvd5nY/s=";
    };
  };
  "tree-sitter-hack" = {
    version = "unstable-2025-01-22";
  ...
  "tree-sitter-humphrey" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1eb388a10dd15264d232d84295422f8f6857c252";
      hash = "sha256-bBrIvPOaqRs4fgorowyW8pObwt1nmWBZzrbLlxuo2/k=";
    };
  };
  "tree-sitter-hurl" = {
    version = "1.5.1";
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "45d4aa93595f2ef43b9345cffa515dff119ee808";
      hash = "sha256-N4LvHj78KU4mU7og0IFsFMBsFXzAbstvzI9bE5v6TQs=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-matlab" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.0.10";
      hash = "sha256-hoxTQc8uQIBNNE9CODjImiT9Db0HgVyG6WobH2I/EAg=";
    };
  };
  "tree-sitter-mcfuncx" = {
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "04630ec19f198c3ac2a0b98a004eeae083990c96";
      hash = "sha256-xAH5iO1WjCWZG1gRF7eMLcKpNQ134UEuKHigVPGKzqg=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a121d411f1b72c38aa28da5ed5f3800f20bd58a1";
      hash = "sha256-Pnan8V6DhC8OizEwAi+wT9VkYaHu1R9R+e16rpwce4E=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "12887a9f497cf280c742b2cd92da0971d9f48010";
      hash = "sha256-2FdVR0wJKH5I27l2pVzPl8btEzHwLHyU5PoJlJc5rEg=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.8.14";
      hash = "sha256-sbWy5D5MouzjujHu8S5tX/EADM6ybXW4DcfrqhY0h/Q=";
    };
  };
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f68e03c0f4ef906303fa26542d1f6eb08b8525f4";
      hash = "sha256-70ZNm+JL4gQ0FpqhOgR13t4ckKJtKyNt/TRofth5+IM=";
    };
  };
  "tree-sitter-tl" = {
    version = "unstable-2025-07-12";
