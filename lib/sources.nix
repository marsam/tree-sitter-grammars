{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-blame" = {
    ...
    src = fetchFromGitHub {
      owner = "github";
      repo = "codeql";
      rev = "7619f1dac9436a2146862aa96635d34b73286de0";
      hash = "sha256-CJF7+GDSF7gmnNbRXmNxKXLao8f4T2XROtYVlPNzUKY=";
    };
  };
  "tree-sitter-blom" = {
  ...
  "tree-sitter-bsv" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5b93f01d8bdba048f0815747fac0fd6d041f87bd";
      hash = "sha256-AXeASD5vuz4Iqw88z2xnJKQ5Ib4gDiGluk01CFH6EK8=";
    };
  };
  "tree-sitter-bteq" = {
  ...
  "tree-sitter-c3" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-c3";
      rev = "v0.2.4";
      hash = "sha256-L1Ogr+ibEeI8aVwk+OMRRWTPmsJBVIMdbrOZfF02O3c=";
    };
  };
  "tree-sitter-ca65" = {
  ...
  "tree-sitter-cerium" = {
    ...
    src = fetchFromGitHub {
      owner = "cerium-lang";
      repo = "tree-sitter-cerium";
      rev = "84ee882e1a7d98bd43e8cd0fe0181a0d3eb9f6b8";
      hash = "sha256-ugiGrwB1tKQeJ8Oqnx1Pf0BhUuBKDK5iaZHllD+ieA8=";
    };
  };
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "728c00e5ebf2b2c42ba8db8ade4440455be4119c";
      hash = "sha256-PSLvZ9wn68G/qBm8hQMRRA2OBNNTQkXP+rurCrQbjtM=";
    };
  };
  "tree-sitter-cgsql" = {
    version = "unstable-2025-01-08";
  ...
  "tree-sitter-crystal" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "cd3ae0751a58bca9fe875e580102578f5228a5a1";
      hash = "sha256-k8sDWR2V0JA5KaL+bTyTdaWiih+tqiAkAMctm/W3yqs=";
    };
  };
  ...
  "tree-sitter-darklang" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "dark";
      rev = "v0.0.152";
      hash = "sha256-3w3Eyp2xNXvAOXv92cueFsQG23UENl+c2MdEhy2N6TE=";
    };
  };
  "tree-sitter-dart" = {
  ...
  "tree-sitter-datazinc" = {
    version = "xcsp3-serde-v0.1.1";
    src = fetchFromGitHub {
      owner = "shackle-rs";
      repo = "shackle";
      rev = "xcsp3-serde-v0.1.1";
      hash = "sha256-41omMab0BLMQMn2PlwEVPco8yr2IJ7XwkxtZMNn0p1k=";
    };
  };
  "tree-sitter-dbml" = {
    version = "0.1.0";
  ...
  "tree-sitter-haproxy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a6e0c52d56208ace4a01b63fae6152580c8d99e0";
      hash = "sha256-R14Hw89QtUhZa5BNPVklB3TEEyOphg/tfc8oMtVkV28=";
    };
  };
  "tree-sitter-hare" = {
    version = "1.0.0";
  ...
  "tree-sitter-i3config" = {
    ...
    src = fetchFromGitHub {
      owner = "abdellatif-temsamani";
      repo = "tree-sitter-i3config";
      rev = "9015225204774ec16ae9679b0fa465fa55d1c336";
      hash = "sha256-WlrudiwtNeSNlBovpiBoj2g5m6m6Hz6Zr/d1JH/g2FA=";
    };
  };
  "tree-sitter-ic10" = {
    version = "0.2.0";
  ...
  "tree-sitter-jai" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "dd2d38d44bf71a0db95c7e745f86b06c3aa7e4d6";
      hash = "sha256-bEkQz/n9WeHqFoM0dB7UhyHDP17G1uwTtFCzWkk+CQE=";
    };
  };
  "tree-sitter-jakt" = {
  ...
  "tree-sitter-jjdescription" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "17d865a4b31d2e00d9a821a28b6651ded45d7a97";
      hash = "sha256-ICbOKbaeWHA2klXfJAl1FYz3CuuzH7Vgbjh5+jKwE/0=";
    };
  };
  "tree-sitter-jq" = {
    ...
    src = fetchFromGitHub {
      owner = "nverno";
      repo = "tree-sitter-jq";
      rev = "987f3c7961505f3f8c19506ab2950dbecd2f96de";
      hash = "sha256-fz4zSCELAHw+YFkD3qlQI35rOspwSDleZb9BotJ8nMk=";
    };
  };
  "tree-sitter-jslt" = {
  ...
  "tree-sitter-kamailio_cfg" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.1.2";
      hash = "sha256-ufUuBEs/po0OzGwU2jGoG9XRJ4WdIUXnkB6Gb+O+6KM=";
    };
  };
  "tree-sitter-kanata" = {
    version = "unstable-2024-04-20";
  ...
  "tree-sitter-lox" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "b09f92de602137acd07f8068803cf514e7550760";
      hash = "sha256-dFr3YT0+XZT8A8wMoHgMfKDl2zgSSX6CHznfRGWWKOM=";
    };
  };
  "tree-sitter-lpf" = {
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "56e9fd35f678b8f46e35e058eccc39f9013a6e1c";
      hash = "sha256-92DAiCPSiwoM3bw09Zyrl2Ohui8cabFSmu6fCbYHe0g=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mers" = {
    ...
    src = fetchFromGitHub {
      owner = "Dummi26";
      repo = "mers";
      rev = "3cd8dc02d2d2b0cbc07504ef3040cb9439b1e5eb";
      hash = "sha256-mehHnwxVxwmXL9fPwGBhE1wUm/rO0w9cXao0MpoLGcU=";
    };
  };
  "tree-sitter-meson" = {
    version = "1.2.1";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f1cb273b1d188d9433839bc48f815b939b5db6ab";
      hash = "sha256-PkoDNGC2YkQtGumwtJk28cUB5od7eVUDzPnM3BYGlZ4=";
    };
  };
  "tree-sitter-mor" = {
    version = "unstable-2024-12-13";
  ...
  "tree-sitter-nu" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-AVSdLrbcIK7cWCWvJk99PCIgwc6t4WsxCXMyWwRHyVQ=";
    };
  };
  "tree-sitter-numbat" = {
    version = "unstable-2024-04-04";
  ...
  "tree-sitter-org" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.3.2";
      hash = "sha256-kYjNQ2VLGciGLDqFEY0Bv+njPtgUlVhtKFjUupfyLfg=";
    };
  };
  "tree-sitter-ott" = {
  ...
  "tree-sitter-owl-ms" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "d1cdccd72516dd6b6504a1e818487022916a2129";
      hash = "sha256-bA7uL+1AE/6fjd4h7jIPLTm5vZx+pPEcOix5HiD7xU0=";
    };
  };
  "tree-sitter-pactum" = {
    version = "unstable-2025-01-10";
  ...
  "tree-sitter-pascal" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.9.1";
      hash = "sha256-IRRPkYqszq99bpDeYDs1/nShc7L/q96wTFF7g6YToeM=";
    };
  };
  "tree-sitter-passwd" = {
    version = "unstable-2022-12-01";
  ...
  "tree-sitter-perl" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-+5j+YkFYorUnPbasgv/mgWHXzu6eaGzHdvebRNLOqhE=";
    };
  };
  "tree-sitter-perm" = {
    version = "0.0.1";
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "49f3d448bbd0b649892ed7d43fdb68526fbe2d9b";
      hash = "sha256-w6hhfU2h/kJD6OY0i1J6pnnEVo14qP1IJnXydepXycY=";
    };
  };
  "tree-sitter-qmldir" = {
    version = "0.2.2";
  ...
  "tree-sitter-sdml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.4.0";
      hash = "sha256-hLxeD1zRnCvmdL0IGESUuF9gOEMX/Aqs0sS051wxKSc=";
    };
  };
  "tree-sitter-sed" = {
    version = "unstable-2024-11-10";
  ...
  "tree-sitter-slint" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-CMwV+nqKwnS+0GLMMevgLgTb8Sm72NOQsVmj/8JoBao=";
    };
  };
  "tree-sitter-smali" = {
    version = "1.0.0";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e53123a37030a8669546fea704f7fa249d4d22ae";
      hash = "sha256-UJuuBW0X8HMNt65XS83xFaYWV5oWVgTuU213uFI38WU=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-sql" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-bp7HNOEYmp7HkVqFvI9AxWoiYftAtMS9tsarJi6vhWg=";
    };
  };
  ...
  "tree-sitter-sus" = {
    ...
    src = fetchFromGitHub {
      owner = "pc2";
      repo = "sus-compiler";
      rev = "a4e84e6bbe9b865bda9f7e33d3b26b514b74e0a3";
      hash = "sha256-IuVOwP5vjWOmiH52/gqOQVvkuTo/HiRqsufg4C1KHy0=";
    };
  };
  "tree-sitter-svelte" = {
    version = "1.0.2";
  ...
  "tree-sitter-tera" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-KKYsJ6XNaSATEFFODXAFkbI9TrB/cUcMEhfzIrqqrTY=";
    };
  };
  "tree-sitter-test" = {
    version = "0.1.0";
  ...
  "tree-sitter-vhs" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-TsttPEy7I2vMFgFBsEFvALCWhuVhdle9m6qzAklAYvk=";
    };
  };
  "tree-sitter-vim" = {
    version = "0.4.0";
  ...
  "tree-sitter-zql" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "adf75b58b635d5d8576ae02fb3345818558436d9";
      hash = "sha256-u3QT1gM/vbeWVV6z5isMoV6fJFHGN738Gb8XCJejT48=";
    };
  };
  "tree-sitter-zscript" = {
    version = "unstable-2025-01-30";
