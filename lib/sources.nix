{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "bfe7b0a7ea6579fd7740104504c63d20101014d0";
      hash = "sha256-y3/O1ecETcI+E71pX+xQmbPE/58VOIGS8qA/3KA7nyI=";
    };
  };
  "tree-sitter-cgsql" = {
  ...
  "tree-sitter-csound" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "742120c2e7d2cca79e9759b7d37607acda87d14c";
      hash = "sha256-HN+Eaf+jr6irFPfwM4Uz7vqYbzQVndIXMY06mJUmzwQ=";
    };
  };
  ...
  "tree-sitter-fodot" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "9425a94ced16b1c65f373010b9dd9e066ccc5530";
      hash = "sha256-gGJCx/D7Mpm9naCl0AfJrRNyxu9Gvqd8p/VaFb163nM=";
    };
  };
  ...
  "tree-sitter-rpmspec" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "f5192661605c67ed8186b65be249aa7ccacc3933";
      hash = "sha256-///3MDJ2qK0LEmAt90kwgzLuuWb/RD5Qag+xAVZn3Mc=";
    };
  };
  "tree-sitter-rslox" = {
    version = "0.1.1";
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e1cb2474ff889284f170aa830988230c18efef7f";
      hash = "sha256-H1hKh45NvLEs4S6R38XhFsBXFWxh46kdXwr2pd4bO5w=";
    };
  };
  "tree-sitter-tl" = {
