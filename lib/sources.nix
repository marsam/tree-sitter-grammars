{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "30cf2f802dab79d149809208a9445dfb8ec3a864";
      hash = "sha256-8qA2XY/PgT/Hw1Tt6uOaMsfqyz3nxzIM+DfSl1hOQQg=";
    };
  };
  "tree-sitter-cgsql" = {
    version = "unstable-2025-01-08";
  ...
  "tree-sitter-enforce" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-B36CLlQQFPUod5PUk1zSsJc0dgjsKXkjVoORbDbRBNo=";
    };
  };
  "tree-sitter-envy" = {
  ...
  "tree-sitter-jai" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "999cb94e0e786d3b5bda1fd332a443fd640082eb";
      hash = "sha256-FfSOl2v4js6pADYElQf7SpVR+ZyIAvyM7oBvKMfeesw=";
    };
  };
  "tree-sitter-jakt" = {
