{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-al";
      rev = "v3.0.1";
      hash = "sha256-yQWs4x9Iz05N3RAeKeuplvlu3hFEW3kX7YCqTAtw+zM=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "967dba2e319e43c1c6bebaefdf7c3a8dd2f1d113";
      hash = "sha256-swRgxO/J9qFit2WuAT0HcLmKIi/PmjwU7gXolX/nRH8=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-inko" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.7.0";
      hash = "sha256-XfIz3R7ufohfAGW2zvjcwu+beAoBjAhsEz5AEOdhjR4=";
    };
  };
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "30f05c80eab5b7ec8de9e0c7dbc23db58e6123c8";
      hash = "sha256-4f9BAh2OyspFKGS9Y/ePR4xASjcCSLNi3tH5TI7IGTQ=";
    };
  };
  "tree-sitter-ledger" = {
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "75a3dec65cd864210718a784c4069b24dadbc2bb";
      hash = "sha256-ghb61rqLOBgxwQyXt+e0VOgZiE2R0byXud3io3aVfug=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "3135b53ba049637bc616ba4921443265cd877d42";
      hash = "sha256-vrDH/zbF5WwilQQvmZxzHyQfLms2REuT6NfZ2jAdH64=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.11";
  ...
  "tree-sitter-risor" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e2a28baa9b37d1b96c5ff32c7b41ef9987ecbeb4";
      hash = "sha256-BsSJmM5DkAK+LoEvQPwsw1hsDRchFg9gwN5p0iICOwA=";
    };
  };
  "tree-sitter-rnc" = {
    version = "0.0.1-alpha";
  ...
  "tree-sitter-slint" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6a4ba2c754fc7ac9c6f1c9e00bbdd550a97e5774";
      hash = "sha256-vyeDMyaluAlxvUGedpvD0NmpBQCZDgeHVAF3OsNg6uc=";
    };
  };
  "tree-sitter-smali" = {
    version = "1.0.0";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2026.6.18";
      hash = "sha256-jEgAIVagcYkiSWvlr10WDm4SLIzwICMQGNZsZFOguec=";
    };
  };
