{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "18c67a74b0e63218157a36ac2fcb4aa160cdc025";
      hash = "sha256-4AlbvnGbenuY0He1/cfINuHpwjPexfX/9HEIE+uVI90=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-6+7L+oZqunDBZJKuWj8K3cs7LZbd7PGSlIQdHNfv8CE=";
    };
  };
  "tree-sitter-ledger" = {
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "761db2e28720b4f9fc8bf68ac10a5045357dd4df";
      hash = "sha256-PjhhdhHxucbCDsb+5fm++6nc4HL1zN617PAm/1R/tnk=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "dff8f793e7d154f909427f5de42476ef72634aee";
      hash = "sha256-okwBiLmcb+h/YIfcCkjvJqxlbE6iFCSxy7MQ20BSK5o=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2026-06-16";
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0f4e69f28e8abb9075c5e3ce1e5b3864df85bfb1";
      hash = "sha256-ddofwDKy2eGUBIGGM0aUjRery3C+SMflD3jHl31SQSg=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.11";
