{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-c3" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-c3";
      rev = "v0.8.2";
      hash = "sha256-FFMRdQ+McVtweCzKUKrYw5Eu+QTIxpBimvh8X8C9s4g=";
    };
  };
  "tree-sitter-ca65" = {
  ...
  "tree-sitter-caddyfile" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5f3f0a70130c78dc8a34f1afea9dfb88f4d2d123";
      hash = "sha256-GGHUaGTK9sMPY94grgXMOGZTN+LN29YVp0uQOZeh2ZI=";
    };
  };
  "tree-sitter-cairo" = {
    version = "1.0.0";
  ...
  "tree-sitter-gram" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.2.6";
      hash = "sha256-ugqZ9lY283HbjAsihXKxwexoNdzDKcLejisazUxtKFg=";
    };
  };
  "tree-sitter-graphql" = {
  ...
  "tree-sitter-jai" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "07d892578ee21774defafc00ca15af9c176dcc6a";
      hash = "sha256-ZeFOmB3NjVsvErTWucAk8dMno84Q/BjAA3wBLign6xs=";
    };
  };
  "tree-sitter-jakt" = {
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "824dab6dba205f548cc6a515e01ef70f04040243";
      hash = "sha256-3QPOA1+1iQKivXmb1PkAT83Q+/1AHC9NXOCc+DdFBMM=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mips" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "fd0f200530d22b9ee526a9646d1b759cf1e55c3f";
      hash = "sha256-C1kPByXJyiHkgnIU35MJG04MnEWuBGS9MQWDrh7P6L4=";
    };
  };
  "tree-sitter-mlir" = {
  ...
  "tree-sitter-pgn" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.3.0";
      hash = "sha256-ZmuzX3StJ3TeEN4HID+CuGPQ8+K1+ej9mgEmGmO0Ph8=";
    };
  };
  "tree-sitter-phpdoc" = {
    version = "0.1.6";
  ...
  "tree-sitter-rcl" = {
    ...
    src = fetchFromGitea {
      ...
      rev = "a6e42ed21e23c32b76c1d8cb13ec60cdd0ed860d";
      hash = "sha256-k9ujmSdOM8xeWaSdEyuwPRTmolzMPFTvoh3m6oEOlss=";
    };
  };
  "tree-sitter-rdoc" = {
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "93e4ad8ddd1ae5ee4dd864f2c98918e47221e069";
      hash = "sha256-nvQO1DLrYH6vFo5qi+aeSfusTnxwCw4oRNKAcYuhWzA=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "51ff9d42ee2a70433259b695887cb96e54536331";
      hash = "sha256-RG7P5QZnMrj5a103Png4Hztbbq+TdhjxR1EYyGIB5Jk=";
    };
  };
  "tree-sitter-tl" = {
    version = "unstable-2025-11-28";
