{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      owner = "SShadowS";
      repo = "tree-sitter-al";
      rev = "f51327bab55ded96828810832634cb116eaba529";
      hash = "sha256-JmaXJsMkpkum+TbsnWWyvBI0lm9S/1kvScNxt3hD5Xs=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-gitcommit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.4.0";
      hash = "sha256-EKiaNEiu6BYmw/2hdyetXvqy2OnrwdUta+VJ/599oCc=";
    };
  };
