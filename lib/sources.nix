{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-datazinc" = {
    ...
    src = fetchFromGitHub {
      owner = "shackle-rs";
      repo = "shackle";
      rev = "a59ddd246f865cda11f990ab73f33fd4da21cf84";
      hash = "sha256-IclN0EDcYsNIZhaH+VJoZe5x8GMupfxI34uqpRCQRzI=";
    };
  };
  "tree-sitter-dbml" = {
    version = "0.1.0";
  ...
  "tree-sitter-zathurarc" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.1.2";
      hash = "sha256-wl4v58/H6MZzLWitsowEkfh9NjdI1PUTTWcVSLNrN7I=";
    };
  };
  "tree-sitter-zeek" = {
    version = "0.2.15";
