{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-al";
      rev = "v3.2.0";
      hash = "sha256-wfp9/idgM25EbZmlFo5iyFU5kSvu/am+oNusY29O9lE=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-datazinc" = {
    ...
    src = fetchFromGitHub {
      owner = "shackle-rs";
      repo = "shackle";
      rev = "5b3693d06193f37a8856de56c6d99778dd48dc19";
      hash = "sha256-HzZ0++1jWJedUtHU+L5d5W6Af/bkzEerwvZqTx3YN6Q=";
    };
  };
  "tree-sitter-dbml" = {
    version = "0.1.0";
  ...
  "tree-sitter-fodot" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "f875fe35398995174dfefcc5f87578085eece9db";
      hash = "sha256-CZG/9ZRlYIFObCxltMUYy4U6SPztNmTwdKr/jhUu48o=";
    };
  };
  ...
  "tree-sitter-fsharp" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.3.3";
      hash = "sha256-LYobcv34x5jCLUIVFzv5nLFDuPUaMZSEYJvY2LCQehI=";
    };
  };
  "tree-sitter-ftd" = {
  ...
  "tree-sitter-hxml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.2.3";
      hash = "sha256-ECKLnpP8eKqJXvX+cuN0P/xqRSBXmG3NHi5J3zE0h2I=";
    };
  };
  "tree-sitter-hy" = {
    ...
    src = fetchFromGitHub {
      owner = "MinmusxMinmus";
      repo = "tree-sitter-hy";
      rev = "3d30b2a95d4bb99ac10af89d6ed9ab721911ec7c";
      hash = "sha256-zivVy2YauiPhea0BEN7b1gwxiEENlBpMGiQ74ahEpXU=";
    };
  };
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ba2035742bc9c5a125ade5d0556db8b2e0773b98";
      hash = "sha256-chIMNIcLgq3ZUfgFrZEC6OHBUEZfQZQotKT80d1ZOTI=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "02502986d1b73f4e8327b5feaa652b7b2b4fb7ea";
      hash = "sha256-qjGRMN8p0Z92XOOwY7xATqJOmOoZuGluBk6kIdxE4Pw=";
    };
  };
  "tree-sitter-mojo" = {
  ...
  "tree-sitter-objectscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.7.0";
      hash = "sha256-Oj9PnkMwsgnyymbSPPZ+1ETABY/l0mMNQ/40l/jFK5g=";
    };
  };
  ...
  "tree-sitter-roc" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "68f405426d030a7625392aabf41836c1aad05d33";
      hash = "sha256-6g/kBK6zAt7QQxyuwGyPQL9F0+7MDUmBro7AjxxOFuY=";
    };
  };
  "tree-sitter-rocq" = {
  ...
  "tree-sitter-slint" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f94f96ce093ec153f037228ac2fac5f1a3cd9ac6";
      hash = "sha256-CeNOS8u3kKkD5+3OyFyGq0MOWYF0lPrqlsZ6Jii7dvE=";
    };
  };
  "tree-sitter-smali" = {
    version = "1.0.0";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "92ab93288d6a5955e488340deeeb6b3cd854daea";
      hash = "sha256-IDTdTmhdmzmMKrHjXefMIFVRDI/a+NQZ3aivDJ04uR4=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-sus" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "sus-compiler";
      rev = "v0.4.0";
      hash = "sha256-Cxfkptp4w1BUC3j+4R9VssrvCluyUzPzVbQNFAl4oMM=";
    };
  };
  "tree-sitter-svelte" = {
    version = "1.0.2";
  ...
  "tree-sitter-vhdl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.5.0";
      hash = "sha256-Q9pihCBv8gLnVNpG3rMHZ4N9qei48OqFhD6YtGnZbFE=";
    };
  };
  "tree-sitter-vhs" = {
