{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-bsv" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ff70637351ec2d0d6cc4db83aeed278b863f05cb";
      hash = "sha256-zIVKvM7HOb2YsQ+McAxOob2mx1+xjUM7bcQ+Ufsuzew=";
    };
  };
  "tree-sitter-bteq" = {
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-BFiXKKgeGADYkOEqbqP32IJlQ4qRZL+8Zi6JiF62cso=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-perl" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-PKVmyZa7u+sHdAttj/byAF/TDv/AYwdnQTO7YoZhXkg=";
    };
  };
  "tree-sitter-perm" = {
    version = "0.0.1";
  ...
  "tree-sitter-zql" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "7378120a4943b75c8918bb84eb5cdbc1678e3451";
      hash = "sha256-U1D4FIEc/juNl6PxM2PjdDVluqJcDePE9eWc8s1l1iw=";
    };
  };
  "tree-sitter-zscript" = {
    version = "unstable-2025-01-30";
