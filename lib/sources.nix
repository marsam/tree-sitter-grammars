{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-elle" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "19d482b7cfc30154d0edf1e472beed6f44bedbda";
      hash = "sha256-7XW0HNlaT56FyWB1oEMskhcZHtn5ek5Nb1ddXJe83KY=";
    };
  };
  "tree-sitter-elm" = {
    version = "5.8.0";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1909c29999d3a0a3fd42384a4748b2a04cefbf0f";
      hash = "sha256-O1vzyyrUwh95eQIRlU3m3pjuREBKOoR5SM3P6Pyl7EI=";
    };
  };
  ...
  "tree-sitter-rustfmt" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2ca0bdd763d0c9dbb1d0bd14aea7544cbe81309c";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.5.15";
      hash = "sha256-3qGVEZdq+LskcpdDa8NCChVDFeVncpCR3ReUVg0jZcA=";
    };
  };
