{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6bb7e74437769b05f56b5a05f80efd8f31034e56";
      hash = "sha256-fj8EQy1rdHMjkHjEplSRO93kSz5ECktk1xSF0S5uC10=";
    };
  };
  "tree-sitter-cgsql" = {
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "bd17546ffaf5e3a56001b9e34b6bc8de6e79da2a";
      hash = "sha256-T3AuZVRJCcUl2kJoVKohjG6lPfuF6Dm6Y92La5csqPo=";
    };
  };
  "tree-sitter-mojo" = {
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f4b3ecc298b13192ff0dafa295b0078d000e5931";
      hash = "sha256-IFkP3RbaPNpKVVAAk/vpVF8zn3RjQXPdLCbbdGGGqko=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-stan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.2.9";
      hash = "sha256-9+JAb2MiOXzzsz7B5C8RWvocR0tgCxLQcAkFXe0pCAc=";
    };
  };
  ...
  "tree-sitter-zsh" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.58.0";
      hash = "sha256-TQuLYPhoOvf6apHxPhvE7rLHIb0M6oMBKWU4jvc63f8=";
    };
  };
}
