{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-gram" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.2.1";
      hash = "sha256-3W8NhX1XcGEWyKp1hylPtyp16kKcI8xilWIDeM9aHPM=";
    };
  };
  "tree-sitter-graphql" = {
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1fe8488cafc61afe9d89b1fec7708345c3ff193c";
      hash = "sha256-tfiXjdT89fpWvSOhT7EvAhlWerHjQ5V1lUfiMyBBQXs=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-matlab" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.2.8";
      hash = "sha256-BNeICrzFhtZHPnePaJbXHMKZBkAIVpVTArg0/NcLipg=";
    };
  };
  "tree-sitter-mcfuncx" = {
  ...
  "tree-sitter-mers" = {
    ...
    src = fetchFromGitHub {
      owner = "Dummi26";
      repo = "mers";
      rev = "6914b1dba27d193e25ea6039caccd0bf997b628a";
      hash = "sha256-7mjGlEM3z3Q53Wi1n7ApviEOHMA5F/QVnxq1aw25nJo=";
    };
  };
  "tree-sitter-meson" = {
    version = "1.3.0";
  ...
  "tree-sitter-structurizr" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2cf4aea92b726e35fa1a2be77587c190e378ea54";
      hash = "sha256-lZng11qynPw7q9MyyiAVYUlrIB0sE2Ur7tZ3mjP1QqM=";
    };
  };
  "tree-sitter-styled" = {
