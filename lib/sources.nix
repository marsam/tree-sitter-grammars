{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-datazinc" = {
    ...
    src = fetchFromGitHub {
      owner = "shackle-rs";
      repo = "shackle";
      rev = "9aa43db0c4293db688a09b31441b02a00dc4d82a";
      hash = "sha256-7ocsGk21VqPu8r6Ie1jvJnEn1CHDp1b2qSwbZoBlrEE=";
    };
  };
  "tree-sitter-dbml" = {
    version = "0.1.0";
  ...
  "tree-sitter-tmux" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.0.5";
      hash = "sha256-Ee9LdGWdXp83OUpiooglF3Z/RGCFjOueq3NxLo7OdDk=";
    };
  };
  "tree-sitter-todome" = {
