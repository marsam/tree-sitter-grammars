{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-abl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.0.51";
      hash = "sha256-0cYVVFJmTandIfl0i7Gc3jbPAqwAVobTz4/pCnKvinQ=";
    };
  };
  "tree-sitter-abnf" = {
    version = "1.0.0";
  ...
  "tree-sitter-caddyfile" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "531abee60f1c8b1d9b567763708fc26690d63833";
      hash = "sha256-+L1fKZK+jNt0HldA6OyM2CP8A/QRz2MbD4y0Mhgaddo=";
    };
  };
  "tree-sitter-cairo" = {
    version = "1.0.0";
  ...
  "tree-sitter-datazinc" = {
    ...
    src = fetchFromGitHub {
      owner = "shackle-rs";
      repo = "shackle";
      rev = "ae042d038442c1478640b41d1cb2592c53f0845c";
      hash = "sha256-0l/+uGDiz3QOgul/qWIK+VJ8xSQCqZ1R0LI3d6O31KU=";
    };
  };
  "tree-sitter-dbml" = {
    version = "0.1.0";
  ...
  "tree-sitter-faust" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-0DrpMqRidCYE8frE/45XFbxD8hbzGznQI9gCbOtOwSE=";
    };
  };
  "tree-sitter-fennel" = {
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "b018021d4add322f8ddf9c8acee3d930f23ec0d6";
      hash = "sha256-e/2+jX3Og7G/LEUFeeWsAQ1GGEuQn7xsCFgj9jT+qK8=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-lean" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-WT9cdOrtA4jV9zbZ6EPTadwAZBn4FQZkv8Dchcwisoc=";
    };
  };
  "tree-sitter-ledger" = {
  ...
  "tree-sitter-lispbm" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0186edda34489931bd4b973fbcdf789ed2d303ba";
      hash = "sha256-bEwgdfHYUkuykvHY0ymUc/AfuSz/WOyJ6wFClewamw8=";
    };
  };
  "tree-sitter-llvm" = {
    version = "1.1.0";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ec226fc960ef2c4df6b92dc710b863868837c6c9";
      hash = "sha256-FcbOEz02542sno1N02Wz9E64Gx5fvorTf+BPf8IG6sE=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2026-06-16";
  ...
  "tree-sitter-rego" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "c2a8c8f9553738afbdfdb9b3b24769ed14e60e7a";
      hash = "sha256-XnG10v71MU/VcXQqvoaArHacc+eFZR5zQiRG7yMvxzs=";
    };
  };
  ...
  "tree-sitter-risor" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6c0a25cd2e8e86168b8aa9bb721f5667e607d93f";
      hash = "sha256-tEJBT2xhAZr45B51X0EwejUkv7wQxK0NJ8IPuhhZdkY=";
    };
  };
  "tree-sitter-rnc" = {
    version = "0.0.1-alpha";
  ...
  "tree-sitter-slint" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "3b539a1d2e36a0594b3464f884327897e9a55dbc";
      hash = "sha256-yl5fLRCcYUIIvju7MIw9PUpjEauPi16TPZdlPtNR8+A=";
    };
  };
  "tree-sitter-smali" = {
    version = "1.0.0";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1f896c10fad547883f7447c4c343d955bd6a0ede";
      hash = "sha256-SdNSSSXaCDHzbrm4XRRsfFj+x56UpVdQ36QOBO3AJX4=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
