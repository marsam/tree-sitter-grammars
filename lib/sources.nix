{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-openscad" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.7.0";
      hash = "sha256-xiWO9GEvwkOTtsk5yFgUYcnMCRElryHJYzrh3PpqfZc=";
    };
  };
  "tree-sitter-orca" = {
    version = "0.2.2";
  ...
  "tree-sitter-risor" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e25784e21a047b02818993fa2edb142882b5cc9a";
      hash = "sha256-CUgsu5Q6yl+5oA1od5xAWSsJfGixMCbMOMliEkEh+0M=";
    };
  };
  "tree-sitter-rnc" = {
    version = "0.0.1-alpha";
  ...
  "tree-sitter-stan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.3.0";
      hash = "sha256-7ZMQ5uNHezJjAjlpUCy8gy3F9q1C8keaiRQE5TMQ7aA=";
    };
  };
