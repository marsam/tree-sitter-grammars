{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      owner = "SShadowS";
      repo = "tree-sitter-al";
      rev = "b8e3bf936b6bbf40025a1dc2464d6dc14693dc20";
      hash = "sha256-aRDIEFBFaeZhW8vfStf6YyiUHxfWa/o0e019/IGyy0g=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-amber" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "015204a37bfda1e099d4385014e08f4832f46a4f";
      hash = "sha256-krW0GIqvPzjrz+R+bZHCn8BPaA/EllHLAw7RMxs8AnE=";
    };
  };
  "tree-sitter-angular" = {
    version = "0.6.0";
  ...
  "tree-sitter-chuck" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "268e216145628b26e5154c033f9627b69459135d";
      hash = "sha256-jSrNBB9e2VmVOIkOWS/eev8zTsRM8i3XffNJwomH0Jw=";
    };
  };
  "tree-sitter-circom" = {
  ...
  "tree-sitter-elle" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "3e7d9c88fb29b8caabc67cf3eb3542dbaddb4b8c";
      hash = "sha256-5yg392Cjk6ExFkkc0dzRFqI6XvowVE7bc9MK8sgdo6o=";
    };
  };
  "tree-sitter-elm" = {
    version = "5.8.0";
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e8135876d3a74138e753050da9234195ba617a12";
      hash = "sha256-ohJEajLm+0bqsIhWRxinCgvmGsQ9BRQPVC8cXblLXKg=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-zyqQ+iG3IKiX/XZR4EL/pgYsMGA3ja3GWfhRhIGRC38=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "7509a71680c407deac61e265d4116ada7a077f8d";
      hash = "sha256-2ncD+/ZarzCV6MbkE1a14OaVwIjDcRImKdtzn979xZs=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-nelua" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "54a2421c2ebfefb544d0c49aadef8497bc7daaba";
      hash = "sha256-ihUEOHFwB697X3pyWMuHM1BKUpe0E7oUXCA7t3wKA3w=";
    };
  };
  "tree-sitter-nesfab" = {
  ...
  "tree-sitter-octizys" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "8e7290cd2f61a753c8924cf5ba03507c4d768c1d";
      hash = "sha256-9oG2iug7bef/Zp0z9bE92nWSq/5q+xRHdULK50EHSS8=";
    };
  };
  "tree-sitter-odin" = {
    version = "1.3.0";
  ...
  "tree-sitter-rustfmt" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "7bb00d7b5e39140b1e5e2cf9fdf17034be996e36";
      hash = "sha256-DTkNs8iFOcSkzmXqLu8Sdoq+WHWHtT0AhKPl8OGxGtQ=";
    };
  };
  "tree-sitter-rvparam" = {
  ...
  "tree-sitter-slint" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-Mp5x0WbUPYm2oSwfnw9POfus9jR2a08Rg54VraGnik0=";
    };
  };
  "tree-sitter-smali" = {
    version = "1.0.0";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.5.29";
      hash = "sha256-XP6OL7Ei00clGMy2ElVkhDXOKPbs1boUqfyBhOplQWE=";
    };
  };
