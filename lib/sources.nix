{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-al";
      rev = "v2.5.0";
      hash = "sha256-BGc4SaOWIJLlyeqNfeGqMfVqecUBBhYgBDYQyGgblGA=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-bsl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.1.6";
      hash = "sha256-Xb3lOg4CeazEum49nmmwkV3kxPrBAe4zPZzqdzpVuIQ=";
    };
  };
  "tree-sitter-bsv" = {
  ...
  "tree-sitter-datazinc" = {
    ...
    src = fetchFromGitHub {
      owner = "shackle-rs";
      repo = "shackle";
      rev = "99d7dc1250dc9dba12e69b3247f71a6ac763489a";
      hash = "sha256-CK33gFADPDvI5i/+vW2/oNPAon1jfIFBumUf50Xonhg=";
    };
  };
  "tree-sitter-dbml" = {
    version = "0.1.0";
  ...
  "tree-sitter-fodot" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "d6a20d62c789b1f46af3059f0b595b0677b00531";
      hash = "sha256-mnYu2a7bORqceFgRSMqKl40SdJvrInfodKqGKGJTK+E=";
    };
  };
  ...
  "tree-sitter-gram" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.3.6";
      hash = "sha256-5AOg/qNtrfQn2aZWyqCrZDAs8JPVMxBsyRPVzggJzVc=";
    };
  };
  "tree-sitter-graphql" = {
  ...
  "tree-sitter-idl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v3.17.0";
      hash = "sha256-cn6niEETmiRRd5M0njyf41lXiFWDbB8oS/5Pf42buiU=";
    };
  };
  "tree-sitter-idris" = {
  ...
  "tree-sitter-ink" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v26.2.27";
      hash = "sha256-R2G1MF+OtfijfcFYK/d6jzXl1VI8mUVahu3TRjNte8E=";
    };
  };
  "tree-sitter-inko" = {
    version = "0.6.0";
    src = fetchFromGitHub {
      ...
      rev = "v0.6.0";
      hash = "sha256-1HoQRCWysE0ySLhJ/CF4z7aB28ficD/LoES+bp23hhc=";
    };
  };
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "acb6fc12853eda8d60411fa87e863f2db904ba08";
      hash = "sha256-ARgm3EjnqWVIj2xxmUgsB3OJSeSCttxkC6XqeK8alrc=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "63dc64a6317c11443749141b2313e24bdba8acad";
      hash = "sha256-TB/r0nsCaIPrdVcbhEmXkHxlU2ESeQv3nCE1hIqBr08=";
    };
  };
  "tree-sitter-mojo" = {
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-JiQNymLy6BSBQKFbinud4uxVOOu5gvCrTBQiJFRJu0c=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-perl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.0.1";
      hash = "sha256-FEYbZvyiXWWGjPOZ+Skcktu8BZGj7ZkYh5XXpxBYnzQ=";
    };
  };
  "tree-sitter-perm" = {
    version = "0.0.1";
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "4d3b9d66628a0e8f36bf6960c4a5c8558d7f38ed";
      hash = "sha256-qpisjCn2qoHlALgiPTyq7HxPGlq4jjbfv7wHhZbq9mQ=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.11";
  ...
  "tree-sitter-rpmspec" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "01e5b9ed82eedb0d70b250406849c90e833f0a0a";
      hash = "sha256-sCDD9f/o+youFftaWuLDahczqLnOLxdGQtaQqeo6Ktc=";
    };
  };
  "tree-sitter-rslox" = {
    version = "0.1.1";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "5ddcff4bdb005ddc4026344385eb81860a180d33";
      hash = "sha256-kucc2vvS4ubkJXt+iZlehXHPuV8anXyKmfAaAWIRekQ=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-surrealql" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "bf420b6dbe1f31da5d6609ce090d19d2a549f538";
      hash = "sha256-CAysiX6IkWVfaOStgoNhCdHose3EqEWILGkcKeOXppU=";
    };
  };
  "tree-sitter-sus" = {
    version = "0.3.10";
    src = fetchFromGitHub {
      ...
      repo = "sus-compiler";
      rev = "v0.3.10";
      hash = "sha256-NAfOb6txfAYg6mq0UsVYL6iU3/LoIXvHK3YPJrm8HOc=";
    };
  };
  "tree-sitter-svelte" = {
    version = "1.0.2";
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a7fa67b29b675372051b4645b6f28f2635bd4ba1";
      hash = "sha256-IfSzqiVx4nc2vnDod3C2ysPbJiKnVXgXLfPohb7e7eg=";
    };
  };
  "tree-sitter-tl" = {
  ...
  "tree-sitter-vcl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.2.1";
      hash = "sha256-erEMm3Llpr1EiWKPUj/tnr/jklaTAGwpR7ozfWoikD0=";
    };
  };
  "tree-sitter-vhs" = {
  ...
  "tree-sitter-zscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "71ca49664c05ab61c3cc1cad44f67e0308dec2eb";
      hash = "sha256-yu8tGKx3VfNwQ+GXO731t0sRum5RJP0OMyUTZ5Gp7wk=";
    };
  };
  "tree-sitter-zsh" = {
    version = "0.63.3";
