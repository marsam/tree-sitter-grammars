{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-javadoc" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.1.1";
      hash = "sha256-tqiOFZXcnOXIUrpYtUG6EQldtJ3aspLKVV6wcvNpoN4=";
    };
  };
  "tree-sitter-jelly" = {
    version = "0.1";
  ...
  "tree-sitter-nu" = {
    ...
    src = fetchFromGitHub {
      owner = "nushell";
      repo = "tree-sitter-nu";
      rev = "9524f8db0802f211a49c085ae003bdf163e199d7";
      hash = "sha256-Nfa6Fmem1/N97ckdmbopTtZ8pyH7j/HPTiivLp3O81E=";
    };
  };
  "tree-sitter-numbat" = {
    version = "unstable-2024-04-04";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "62280c1ef958b2f65f28f2d45d509c3cf9363892";
      hash = "sha256-KThuIy56m+leiRx9PgAjo1c60p+FQYm45To2ltftDeE=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
