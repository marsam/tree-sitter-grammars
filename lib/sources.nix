{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-caddyfile" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "b4021950903ff12e90454c318eb4a2171582f141";
      hash = "sha256-m3Y8k6KRJhX7GyDUfy6PyEE+x5WVWuxrz3twg/qIlY0=";
    };
  };
  "tree-sitter-cairo" = {
    version = "1.0.0";
  ...
  "tree-sitter-cedar" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.11.1";
      hash = "sha256-yVOzqzd7xgMKH8uTHpPrv4p7LN63fqoCFfo15jrPKuA=";
    };
  };
  "tree-sitter-cel" = {
  ...
  "tree-sitter-zathurarc" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.1.1";
      hash = "sha256-18SIe13xSyx72dmGRA5WbNdU7DQxcVMycZlsyizK5hM=";
    };
  };
  "tree-sitter-zeek" = {
    version = "0.2.15";
