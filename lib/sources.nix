{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-chuck" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "3ef3d8e60646efebafa9776b2f708e3528b5a44f";
      hash = "sha256-cFYiMQ3Elvq2M957DWP0rAtbp6Po3+L38s7vrA8Dr2c=";
    };
  };
  "tree-sitter-circom" = {
  ...
  "tree-sitter-hygen_template" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.4.1";
      hash = "sha256-1YuOTUCiuGMrD7sPUZiSubpzma9h9Uim8SpfLlfH+Fg=";
    };
  };
  "tree-sitter-hylo" = {
  ...
  "tree-sitter-nu" = {
    ...
    src = fetchFromGitHub {
      owner = "nushell";
      repo = "tree-sitter-nu";
      rev = "ef6943509fafd167b1e10bc12729b3c23b4f3df4";
      hash = "sha256-Jf8+1eRGh0zQI7aaFnwnsQbwwqJ0L+jmsZu3NsQVywc=";
    };
  };
  "tree-sitter-numbat" = {
    version = "unstable-2024-04-04";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "c0d3026462d118b789fc016c5d6ae77cccf4ca03";
      hash = "sha256-1BHZ+jkYCyIox08IduAdVTYGUA4e2MD9EMWQFH7LLUs=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-zscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "3332adb9c9dbcee8fed4e4de41abf1004f6e10ad";
      hash = "sha256-M/hBRLyWBBXyTVQJBssNB3Hvi6d5nVo1uFy9Zf0Bvcw=";
    };
  };
}
