{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "fc6f378f2ce6ceee11ea31fbfc8d72955d9bbe27";
      hash = "sha256-lti8hm7eejR4Gz5HW9MO3PT56N4837PiHI2epbtIFtw=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0a9622038b00e2122a0e5414f4fd927dd7b3bd5f";
      hash = "sha256-Izj/kRiKUI62G/mg00hY31BmyVF5I0VkT7/ev/NeCes=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-sus" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "sus-compiler";
      rev = "v0.3.0";
      hash = "sha256-ir3xTv0krsp6pAIJ0AqQZN1eZeYYJn9aAmHQwNP0n2I=";
    };
  };
  "tree-sitter-svelte" = {
    version = "1.0.2";
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1cdab9ba4dd4e682276e307c4452e33eaf09d15b";
      hash = "sha256-l2vdXGm+cOGO3QUUhDf0XcL+tpebiqlJgZTv3foaUWY=";
    };
  };
  "tree-sitter-tl" = {
    version = "unstable-2025-07-12";
