{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-angular" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.5.3";
      hash = "sha256-J7LWVx6IahXhsii1CLouexsU/F9x3jSmusnpRqZZ50A=";
    };
  };
  ...
  "tree-sitter-automad" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "bade2ebe9fa8373eb1fc6e963b563371069339b6";
      hash = "sha256-n76w0ZKfSzu243P1OVk5+bQLgPp5zOlaDVNHtTK4kVg=";
    };
  };
  "tree-sitter-awk" = {
    version = "0.7.2";
  ...
  "tree-sitter-esl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "538a6efa621072844727f3ed94284860f91f4f68";
      hash = "sha256-0E26lAdwEGfUjALBmYGCg9jch2wihc0NWaKO4NmGtTE=";
    };
  };
  "tree-sitter-eu4mod" = {
    version = "1.0.3";
  ...
  "tree-sitter-koto" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "25e4eed7ecd8a071798529de966fa72f7ea7bda5";
      hash = "sha256-kIN9Dwu3CFAeBIQJrhiYRMnMw20vlZjZsq9iEwR9ey0=";
    };
  };
  "tree-sitter-kusto" = {
    version = "unstable-2023-11-03";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.3.20";
      hash = "sha256-OXjSsyRKCcX/QtaKHAi/IHmMsnWD/POqtpTNG5Cnmfk=";
    };
  };
