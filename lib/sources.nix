{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-brightscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6d6471a7c20211e867c30a21ee5fadb1879b5061";
      hash = "sha256-Iw3jv0tPdo4u5odAEpVhBPo0ST1sUEGn+mJuA4BK1L0=";
    };
  };
  "tree-sitter-bru" = {
  ...
  "tree-sitter-tcl" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-rlhI1EN+rSjecpYOmbXt8aEC+WYeq5ubUyqWQtvMf44=";
    };
  };
  "tree-sitter-teal" = {
    version = "0.0.4";
  ...
  "tree-sitter-zscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "9e16ef5b8585c4b22700c71aa7c46973bc1d5fe4";
      hash = "sha256-2eiWyGQyFZRATLGIEzUxGyVWafMj2Mc0V4xIzaZ2t5Y=";
    };
  };
  "tree-sitter-zsh" = {
