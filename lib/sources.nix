{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "7f821c17c1b109ecd4f7559bb5ebb7eff5315cbc";
      hash = "sha256-prAyuH92cfTunZYAhKoN2o6WiRd4BJ0gdpnT8SovZfk=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "60d1feeabf01f730e6b8500e23918d9972772baf";
      hash = "sha256-LEOehsBWc4uW/2yd89KYG++iMJEItx+BWw0CepoGovs=";
    };
  };
  "tree-sitter-mojo" = {
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2026.4.2";
      hash = "sha256-sxdXarQZpMVOVnVE4ILGytLkq6SPIhCzJIDZwS/X+sc=";
    };
  };
  ...
  "tree-sitter-zscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "35c1449ddae6bc647c952a79e39ca848a31a1b9d";
      hash = "sha256-NXiahBPzAzXZD5qU37T1hbSQSKoRArPfQbaSgTst+10=";
    };
  };
  "tree-sitter-zsh" = {
    version = "0.63.1";
    src = fetchFromGitHub {
      ...
      rev = "v0.63.1";
      hash = "sha256-OJ4zb5NopLb7hwUQ+obDLIhXGPf5tk2rj+oZgj1aEW8=";
    };
  };
}
