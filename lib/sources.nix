{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6b58b2c3916435eb654f9bf7ddfc4a4572789fb9";
      hash = "sha256-7mzCReT8B6Ese1ZG+KaCt58pygDSZ6uP55UZkytKiUA=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-nu" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-v4Nr+dN7VT4AMuejvDWJZK0+wH9/Q3h29vvAKYABaXE=";
    };
  };
  "tree-sitter-numbat" = {
    version = "unstable-2024-04-04";
