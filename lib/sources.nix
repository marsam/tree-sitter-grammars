{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-elle" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ee266606de26a8c0abb2a91575db48a0f4c8e133";
      hash = "sha256-84GwKDUA26bSvKnluLzTwfeKz7//lH5/dY43HVFLqoc=";
    };
  };
  "tree-sitter-elm" = {
    version = "5.8.0";
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "05469c78e4371a9da403016472fd79ad77074cea";
      hash = "sha256-GM8+pErQqR/y6nAHj7yKw2jJFOU/amsdHMuoJARXEIE=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-q" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-q";
      rev = "v0.2.7";
      hash = "sha256-feo8TUORwXBtztVM+Hi4chVq7U8T+RnQ+sqsFGJ3XVs=";
    };
  };
  "tree-sitter-qbe" = {
  ...
  "tree-sitter-templ" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "bd52132b4ef7a028189f0e52d7c89e36a083c6fa";
      hash = "sha256-04V0T+KLZnXvxxem1ES02sOysO6Wo0Bfs0kFXWunve8=";
    };
  };
  "tree-sitter-tera" = {
