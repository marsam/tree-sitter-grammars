{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-gritql" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "fd8c5f155b0cb365e21f37caa43d5f8a5714350a";
      hash = "sha256-9z6l3JfGaOV6OPVoi3umddTbJx6WVvouyp/ue/hOwuI=";
    };
  };
  "tree-sitter-groovy" = {
  ...
  "tree-sitter-matlab" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.2.9";
      hash = "sha256-TERkf0OLI2KdIYpd8YuQQY90q7tu04VgPdb6bGHIcoo=";
    };
  };
  "tree-sitter-mcfuncx" = {
