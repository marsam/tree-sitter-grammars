{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-bp" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-bp";
      rev = "v0.6.0";
      hash = "sha256-Yiw8IFa5pBfvsOPV+uGRTk+doIHbAWdYV3t+378JrOw=";
    };
  };
  "tree-sitter-bqn" = {
    version = "0.3.2";
  ...
  "tree-sitter-esl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "11a6ea3cf5b22626c023eedf9898842d7288fb13";
      hash = "sha256-O+fSC8k/Aa8s61GQ8jY0V3BxSeYpa2nLlmGFRI/8kXw=";
    };
  };
  "tree-sitter-eu4mod" = {
    version = "1.0.3";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "8c17b59f16adaf87813972df0cbf193825825f47";
      hash = "sha256-Rqj0zxsHsNTgtq7CcXa2bJKEgVNxZKq03FkXH4zP/8E=";
    };
  };
  ...
  "tree-sitter-q" = {
    ...
    src = fetchFromGitHub {
      owner = "Gchouchou";
      repo = "tree-sitter-q";
      rev = "774b545af3707779d9e2b827988dd5cba7957bfa";
      hash = "sha256-YhZ4L+miZwkUC3NQBxRXkPSukksqKiFzt6T+LyCi/14=";
    };
  };
  "tree-sitter-qmldir" = {
    version = "0.2.2";
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1c41f48a9d98898d35a4bc911259fbaefcc71d9c";
      hash = "sha256-oNk2LJTby8ntO+pLke9RqU2QZFb4/YvAjMCOCdWNf0w=";
    };
  };
  "tree-sitter-tl" = {
