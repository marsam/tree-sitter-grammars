{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      owner = "SShadowS";
      repo = "tree-sitter-al";
      rev = "c34d41345d0c39a3a5a5ae3f104a7e30d0817d23";
      hash = "sha256-vDbfxiqoAS3SpE82GDjv+OKByPcBLGmgKaTWPR7FuC4=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.2.0";
  ...
  "tree-sitter-c3" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-c3";
      rev = "v0.7.0";
      hash = "sha256-zMXdCT5o+2c2cEg+iz+eOat/OfM3tENBM1u9sg0AqGc=";
    };
  };
  "tree-sitter-ca65" = {
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "93137b58608b4e68fdd3005fe7ec3d9d67038057";
      hash = "sha256-gb+NRPUh8UTH+7Ssi0PEjoIkndXMCegevWvRqpeXtGA=";
    };
  };
  ...
  "tree-sitter-slint" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a6066efeac2c9ddc9ef5019611846ebe8e25711e";
      hash = "sha256-PkzkF3X9Mfdl5srXiqzxKWGJjOvlfMC9mjhxN+Np1Ns=";
    };
  };
  "tree-sitter-smali" = {
    version = "1.0.0";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.5.22";
      hash = "sha256-2FyzyK0zyrkwokfB4lvU+Vng3LFmLXlWIiohlxCcNJY=";
    };
  };
