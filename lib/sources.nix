{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-chuck" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a387a3c0490108d8af8f65ee258efe85a80d5f42";
      hash = "sha256-HAzUCf9tZkzKKa7OjwBOu6cYxQZrfrt+M6q+ra3Tgfw=";
    };
  };
  "tree-sitter-circom" = {
  ...
  "tree-sitter-nu" = {
    ...
    src = fetchFromGitHub {
      owner = "nushell";
      repo = "tree-sitter-nu";
      rev = "df4e4c8e8887db34285293cfb1cf09127b2aa41c";
      hash = "sha256-RgfWdh0GQzKMfiZA+5nih9uGoSEPMtj18sRkSCSWIPA=";
    };
  };
  "tree-sitter-numbat" = {
    version = "unstable-2024-04-04";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.6.19";
      hash = "sha256-P1F+U2GjhLlhpYHx3n4zFlEB9Qis/z7cGti+YSe8fN8=";
    };
  };
