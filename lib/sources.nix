{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-brightscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a556a2720bbde1c647c19d3046607837e75aa34b";
      hash = "sha256-nC01s81K0cH3b1G82lk6mzpd/fiA1QLzyNqD+mGR8JY=";
    };
  };
  "tree-sitter-bru" = {
  ...
  "tree-sitter-catala_en" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "8a826424bc20aa071858a9f43d4fe795103b3eb7";
      hash = "sha256-aaR+yUH5kuUIE06oEEL5UVNk6BawvIGrrKQSEJq7QzE=";
    };
  };
  "tree-sitter-cds" = {
    version = "1.0.0";
  ...
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "af477ab5547b954ce10be816ff26bbbfce72edfe";
      hash = "sha256-Yn371PZ0DhcLGQUlLddUz/7Oh5p4qoOe7QTqyWEolLs=";
    };
  };
  "tree-sitter-cgsql" = {
    version = "unstable-2025-03-09";
  ...
  "tree-sitter-dhall" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.2.1";
      hash = "sha256-g4Z4NNsAsJ51OAHoON7i/8p3iQty40BrJwSTDOopwzc=";
    };
  };
  ...
  "tree-sitter-forester" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ceb1af41199f51423d4952c2b9ccda257b94997d";
      hash = "sha256-FwP3QmWw2qqkLYWKXilFsGeGd9Af1/TvgGWtQrpNYpM=";
    };
  };
  ...
  "tree-sitter-haml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.0.2";
      hash = "sha256-/ntB4s91DRKWFMra+CuncjW6dNti76e0Obxo41I06Ik=";
    };
  };
  "tree-sitter-haproxy" = {
  ...
  "tree-sitter-lilypond_scheme" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "47dfff8fdb7abf7dd68aaa1d4cdd56aa8446c27e";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "290094725390a4e5f4fdb0524d1be037016890ba";
      hash = "sha256-kNAZkP6eomOjeZDVXBABYFjU3jL67+7s8C+hrxn//SE=";
    };
  };
  ...
  "tree-sitter-npf" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "dba734a638ce8c783f8821868ebe4ab4666ad7fb";
      hash = "sha256-CGD1RxNNTQWTMQ1I9xtrwmd+LTgw7i7AGgoQX6Bw2D0=";
    };
  };
  "tree-sitter-nqc" = {
    version = "1.0.0";
  ...
  "tree-sitter-pkl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.18.0";
      hash = "sha256-Oh6bn28mBIA/W37zjE2Q9xigJvnho3P1AfnEgBcM89M=";
    };
  };
  ...
  "tree-sitter-q" = {
    ...
    src = fetchFromGitHub {
      owner = "Gchouchou";
      repo = "tree-sitter-q";
      rev = "8141b16291e92cdb2d4deafa95ce0c066d1c03ba";
      hash = "sha256-aB+jHeFNwrqoh1Uz4xSoad7xbT1v6lNTuLWM2TrHsMo=";
    };
  };
  "tree-sitter-qmldir" = {
    version = "0.2.2";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "473f8059ff38cf59df25d7045ee026735fa02efa";
      hash = "sha256-mZFkV2n30ZAsU/CmaxaCp65XPLKzJj1rSzMDQbHX3EA=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.3.27";
      hash = "sha256-WGh3NFhqzjzaJG/ujXHvfXQnbvWosH7NaT8uJmFZyVQ=";
    };
  };
  ...
  "tree-sitter-t32" = {
    ...
    src = fetchFromGitea {
      ...
      rev = "v5.4.2";
      hash = "sha256-oIAOpuz5p+BdJhixBuYXrtHVBuVwgQNgIS8jSxxWOso=";
    };
  };
  ...
  "tree-sitter-tcl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ef80d41fdbebd6c705925a7b25602a69b1de9dc3";
      hash = "sha256-RiYh7MwBf12Nvljgh6ATNirm3xWNzYdJh6UFJb1Otic=";
    };
  };
  "tree-sitter-teal" = {
    version = "0.0.4";
  ...
  "tree-sitter-templ" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-+mzHXYSQjTizSm31ew5px/0p9JctGAPyUI1yLKWPnvw=";
    };
  };
  "tree-sitter-tera" = {
    version = "unstable-2025-03-29";
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "fa216fb2375ddf4e2fc7ed4406b4911b818f2dc5";
      hash = "sha256-cr9DBq+LnHUp8kK9l13FPK6roAK1DsQPZVU3TeoqOBo=";
    };
  };
  "tree-sitter-tl" = {
  ...
  "tree-sitter-typespec" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-2pdLuCSNw16mJmkeEx6Vp+hv1CzbMoxYULr7hE3bm/E=";
    };
  };
  ...
  "tree-sitter-wit" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-6/i3DL6vPhyOEkuhDm44/puq1//Kk4qeyMiO/WbERn8=";
    };
  };
  ...
  "tree-sitter-zeek" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.2.8";
      hash = "sha256-ubjXvR7Lcq0Pjr8Ob0UvTR2x7nUMBWx51G9BOEipYvw=";
    };
  };
  "tree-sitter-zeque" = {
