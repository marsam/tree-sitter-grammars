{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2de5f180dea85c4540c3e6e156416f9b296084db";
      hash = "sha256-JbB1ZOr4ohi1ir4LN9YgUqLRsHXM/cT3dz+kJY2sZyY=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-nu" = {
    ...
    src = fetchFromGitHub {
      owner = "nushell";
      repo = "tree-sitter-nu";
      rev = "ef125933dc254e5b362f32ef4f364186091414e4";
      hash = "sha256-UoX6GU3SidHKhGioKSF1H8/1DUMyt2SnLBYEhBboQSU=";
    };
  };
  "tree-sitter-numbat" = {
    version = "unstable-2024-04-04";
