{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-bsl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.1.7";
      hash = "sha256-YzFoZT+czjDYfv9EkWGZ9/XjbOVA6t0/WHwZwLqNSgk=";
    };
  };
  "tree-sitter-bsv" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "8c7f59f5fa86a73d56c97bbb1b84e0d5951364d8";
      hash = "sha256-74wHybPxNQTOhiYZgwA/75bBpcHItmOp7tRsVVA/WYI=";
    };
  };
  "tree-sitter-bteq" = {
    version = "unstable-2024-11-10";
  ...
  "tree-sitter-clingo" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.0.6";
      hash = "sha256-Af5+rW923CDIhR8TiBfXthPUSRqDwlNqdbIRyyp/D0s=";
    };
  };
  "tree-sitter-clojure" = {
    version = "0.0.13";
  ...
  "tree-sitter-curry" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.0.4";
      hash = "sha256-/TtZYomdVNxvWtoNozyjygvKl/pWWpfFNIm3KSGv8lo=";
    };
  };
  ...
  "tree-sitter-datazinc" = {
    ...
    src = fetchFromGitHub {
      owner = "shackle-rs";
      repo = "shackle";
      rev = "a4ef7c8950ef85c2876424c3086f553f10f383c2";
      hash = "sha256-7Fm2IfV470f+sq5Uv7eADmwHdK1qKq6kUcGOCdHGXhU=";
    };
  };
  "tree-sitter-dbml" = {
    version = "0.1.0";
  ...
  "tree-sitter-epics_cmd" = {
    ...
    src = fetchFromGitHub {
      owner = "minijackson";
      repo = "tree-sitter-epics-cmd";
      rev = "v0.1.5";
      hash = "sha256-AWJWuH+NDATjYv2T4majHn5bu0M7IRYpqI7uUO4P3Z4=";
    };
  };
  "tree-sitter-epics_db" = {
    version = "0.2.0";
    src = fetchFromGitHub {
      owner = "minijackson";
      repo = "tree-sitter-epics-db";
      rev = "v0.2.0";
      hash = "sha256-ROw6XWGQS5OTlAFOYrUdE0Q+MXcVnxPkQ3GD2qt9rsk=";
    };
  };
  "tree-sitter-epics_msi_substitution" = {
    ...
    src = fetchFromGitHub {
      owner = "minijackson";
      repo = "tree-sitter-epics-msi-substitution";
      rev = "v0.3.0";
      hash = "sha256-+7Y4jYXs+SJJTBWMJsUWrxJrTrLaQXzEUKuZXQ9hek4=";
    };
  };
  "tree-sitter-epics_msi_template" = {
    version = "0.1.2";
    src = fetchFromGitHub {
      owner = "minijackson";
      repo = "tree-sitter-epics-msi-template";
      rev = "v0.1.2";
      hash = "sha256-+MKWiN3RnVg1ZatnVhtLlBaXRLH+t3/jnHFFIvItl0I=";
    };
  };
  ...
  "tree-sitter-expando" = {
    ...
    src = fetchFromGitHub {
      owner = "neomutt";
      repo = "tree-sitter-expando";
      rev = "0.0.3";
      hash = "sha256-WbsudRHujxihl7BuDc1Sh1mX/ZEqM/HJR4TJfHbvMOs=";
    };
  };
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "20e105460fce849e62eb8a561d4ca0edd038d880";
      hash = "sha256-ZQo4YDTfZFTnKyuPMlWVKl9E+KcIuqGwsEYEeQWCegU=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-gram" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.3.11";
      hash = "sha256-Z9mZNZhx/9BdLtMC03Huht9IuQXmgRE9Hp5qLybZR5s=";
    };
  };
  "tree-sitter-graphql" = {
  ...
  "tree-sitter-haml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.1.2";
      hash = "sha256-VGBzBC+lHgk0MaEkyr5VsGwjzs3R2gYKyUibSX6Wtjw=";
    };
  };
  "tree-sitter-haproxy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ef605151993ff0128eeb9fcb3af8035ae8b0d82c";
      hash = "sha256-6ujE+WqFInKHOdkCdUX0SvGBXjGVpeabuP6KfFfov5Y=";
    };
  };
  "tree-sitter-hare" = {
    version = "1.0.0";
  ...
  "tree-sitter-hxml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.2.4";
      hash = "sha256-Dn+YxBsJhy5KGyXyKUbr10Ad/RnmmLXIidgSCNTxQE0=";
    };
  };
  "tree-sitter-hy" = {
    ...
    src = fetchFromGitHub {
      owner = "MinmusxMinmus";
      repo = "tree-sitter-hy";
      rev = "143ef86c43eeca07d9dcf27f6d4bbe887762f9fc";
      hash = "sha256-D7WUcl8ajRUrWFULCQ0jtn2xugis6Pf5pujA57EUUNs=";
    };
  };
  ...
  "tree-sitter-ink" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v26.5.5";
      hash = "sha256-EjV5VKtQxBcPYAYiVwR4CgmKcNYaNp35QuFYfyHqPPc=";
    };
  };
  "tree-sitter-inko" = {
    version = "0.8.0";
  ...
  "tree-sitter-jai" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "96440b0f78a45bed1668d5693f26c0d30b4d1a84";
      hash = "sha256-nWN8BBbv/BiCrLQ9PQGGabQbLIfosiVcvFXawkTmCN4=";
    };
  };
  "tree-sitter-jakt" = {
  ...
  "tree-sitter-koka" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "07b1ce29a06656b552f7f198e572499062ccfffe";
      hash = "sha256-OHe36PUNJBBHTz+AEsjylOVbec+EVbkX2p1nszPg+7E=";
    };
  };
  "tree-sitter-kos" = {
  ...
  "tree-sitter-lispbm" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "13f9f9efcd963c51cdb36556abb0ffbb77b6dd4b";
      hash = "sha256-Q6Vc1AtiAbfjMRGHm6LkPiahLnPD6fFGs6Y0Oxoct8k=";
    };
  };
  "tree-sitter-llvm" = {
    version = "1.1.0";
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2b56baac3fb4d9a605f1c0db579cd282b77bce3e";
      hash = "sha256-laf0hjiRre0tTsfgqg+pMuskKpo7mBI9XL071mTTK7Y=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mdn" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.1.7";
      hash = "sha256-jd7LunWNVEVhvHeN0XrZFxMfFsAuUWvDJCBzcs3bljQ=";
    };
  };
  "tree-sitter-mdx" = {
  ...
  "tree-sitter-mips" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.3.1";
      hash = "sha256-fixAqj1txVDzqlZUk6K8MaJrKr37VBpFY9nKoJHW6aU=";
    };
  };
  "tree-sitter-mlir" = {
  ...
  "tree-sitter-mojo" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "bf85507ab30b4022e2b8f8a17ef8ad702c89b45b";
      hash = "sha256-FSkPfzZTtvxkWpOhgVt3HbNcXS10q9ERJLl4gDkjQKY=";
    };
  };
  "tree-sitter-moonbit" = {
  ...
  "tree-sitter-mustache" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f73f2bfcae7ef093eda247fb85ea2bafcaab49c0";
      hash = "sha256-pWrghE6Q/L94cQP9D0/9WCVn7GZSrEDiQmt9pNP0WIc=";
    };
  };
  "tree-sitter-muttrc" = {
    version = "0.1.4";
    src = fetchFromGitHub {
      ...
      rev = "0.1.4";
      hash = "sha256-Fg1XTEUI+92S4HTilVm4mv694LKnMWjcIHVH2aPH6us=";
    };
  };
  "tree-sitter-nasm" = {
    version = "unstable-2024-11-23";
  ...
  "tree-sitter-noir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "89cc4dbbfbc4ab3fadf75bf8f5c54d6a5f8ce682";
      hash = "sha256-BQfEQm1D+rKABdMBHVpuGAJvQj7w8zBLgjp/1OHVn0o=";
    };
  };
  "tree-sitter-nois" = {
    version = "unstable-2024-04-20";
  ...
  "tree-sitter-p4" = {
    ...
    src = fetchFromGitHub {
      owner = "oxidecomputer";
      repo = "tree-sitter-p4";
      rev = "c31780d3f4a38d00e62d7d4ee0cd90856aeb47e0";
      hash = "sha256-FWzFfb+2KVpsWddaS7ZKSeQ6vCTUl6M183q16z5bwD0=";
    };
  };
  "tree-sitter-pactum" = {
    version = "unstable-2025-03-16";
  ...
  "tree-sitter-pkl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.21.0";
      hash = "sha256-I6jz9MksI+aiuxMQ3hZ1VyksA+rj3XxRKHfe8gkoO/I=";
    };
  };
  "tree-sitter-plume" = {
    version = "unstable-2024-05-26";
  ...
  "tree-sitter-q" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-q";
      rev = "v0.2.12";
      hash = "sha256-RCi9gA04wp/oAw44XBA3CJkbHjOHb68pevzBn0gMHDo=";
    };
  };
  "tree-sitter-qbe" = {
  ...
  "tree-sitter-qmldir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.1.0";
      hash = "sha256-lQl2FpdtqBQq0eE/JwqMKHH8K+UtOfUR/4iolexsDXU=";
    };
  };
  "tree-sitter-qmljs" = {
    version = "0.3.1";
  ...
  "tree-sitter-rpmspec" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "7d1557162655f677729dca90cc180aca657053ec";
      hash = "sha256-kcoXqvC8ZveJQU2AFs/wq2EUfrnQhuzs8YUI0/E7/qY=";
    };
  };
  "tree-sitter-rshtml" = {
    version = "0.1.6";
  ...
  "tree-sitter-skbdrc" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "69edaa1ab732531eda60618915945ffc744e3ed0";
      hash = "sha256-BBAX3xLmSRy1gUpDSJWmNcPs3SC2gFdF3T9LCz5rc3s=";
    };
  };
  "tree-sitter-slang" = {
    version = "0.3.1";
  ...
  "tree-sitter-spade" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "136376ceaa2a765d25be3cc19df725e2f61f5301";
      hash = "sha256-eR2HE5gDZ1h9uXAi9Eg/Ew3uW4mxbhfEMPVXWlNjZxY=";
    };
  };
  "tree-sitter-sparql" = {
    version = "0.1.0";
  ...
  "tree-sitter-spicedb" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6bba27682a2f4e297a8f6fd19539f550d27009e2";
      hash = "sha256-3GfRDtRuNRfwaDmipzkEBNl0F2j+mKjJiy6OZT6gIiA=";
    };
  };
  "tree-sitter-spicy" = {
    version = "unstable-2026-09-08";
    src = fetchFromGitHub {
      ...
      rev = "f93f58bd127defaa0cd6333372c0471360e809bf";
      hash = "sha256-saFoHPDTtth4q2nPL7CBMX618CVnJRgHOWO5IPYYIQY=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-stan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.3.1";
      hash = "sha256-giE7ytMJaQBxwm/1+UskLCWli3i1sXfrL7laYUXxC2g=";
    };
  };
  ...
  "tree-sitter-streamdevice_proto" = {
    ...
    src = fetchFromGitHub {
      owner = "minijackson";
      repo = "tree-sitter-streamdevice-proto";
      rev = "v0.2.1";
      hash = "sha256-HFsLOpc2Qqsucoo+X1rRGGpcaSIBqL3myfL0hoqoTw8=";
    };
  };
  ...
  "tree-sitter-surrealql" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "329dcec0a057e4bc25d71e2c97e16c391573ecb0";
      hash = "sha256-XeIABZ4KKOjvPkpLttN009TgKdy2bPypMIcA/SGiJTo=";
    };
  };
  "tree-sitter-sus" = {
    version = "0.5.0";
    src = fetchFromGitHub {
      ...
      repo = "sus-compiler";
      rev = "v0.5.0";
      hash = "sha256-WRY7MXGSGc5F4bFwRUqVQw4Q0hejX/exmndLnzGevFg=";
    };
  };
  "tree-sitter-svelte" = {
    version = "1.0.2";
  ...
  "tree-sitter-tmux" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.1.4";
      hash = "sha256-L0MBSDLrtwwl4K5G2AB5I8egkmA2kN66nZ7GqWAIc8g=";
    };
  };
  "tree-sitter-tmuxf" = {
    version = "0.0.4";
    src = fetchFromGitHub {
      owner = "Freed-Wu";
      repo = "tree-sitter-tmuxf";
      rev = "0.0.4";
      hash = "sha256-OaH21rcw9k9QSjc0lUBWzgSzVx0eGdEwY7YDDXTgLYQ=";
    };
  };
  "tree-sitter-todome" = {
  ...
  "tree-sitter-umka" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "78a4c27f63cadb2ec5adfb67f082a9f7f16660d1";
      hash = "sha256-S7geSDmy3h+sstH7LN4G4H6A8nu3HkrPWIVlMedu6BY=";
    };
  };
  ...
  "tree-sitter-ursa" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.0.29";
      hash = "sha256-7ml5Kw/+c5zFYcz/YudsJ/YZrPgTCrNZH/mHnNp1iV8=";
    };
  };
  "tree-sitter-usd" = {
    version = "0.8.1";
  ...
  "tree-sitter-vhdl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v2.0.3";
      hash = "sha256-zDEO5X9aewylftSEOFiczfSZsuj1yd8JDqOkwOXLF1o=";
    };
  };
  "tree-sitter-vhs" = {
  ...
  "tree-sitter-zscript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "75ff06e2b4fb7bfcdeb165ecb12a20dfea3c318d";
      hash = "sha256-0GIS+idwAmNh4OdE7R0GhbYUiwnjnlcCueUdk7bt67c=";
    };
  };
  "tree-sitter-zsh" = {
    version = "0.63.5";
