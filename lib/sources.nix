{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-al" = {
    ...
    src = fetchFromGitHub {
      owner = "SShadowS";
      repo = "tree-sitter-al";
      rev = "890d708ca2318206b95858423336887c62b8f0d6";
      hash = "sha256-mTw/lq0GkKqa+odlh9sUq+gv3co5C7mm15P/TKwliSI=";
    };
  };
  "tree-sitter-alcha" = {
    version = "0.1.1";
  ...
  "tree-sitter-amber" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "42da795f59aef20d8f8564ba51642a7caa7fa328";
      hash = "sha256-hRkFo9nVKg/sgVz9z09GMRFlODOI8wSWIjfu8TfUPoM=";
    };
  };
  "tree-sitter-angular" = {
    version = "0.6.0";
  ...
  "tree-sitter-c3" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-c3";
      rev = "v0.5.3";
      hash = "sha256-FxjP/HcJr0J3vwZSwXpnWHaCm4Riyb8tiTmiWzGx6dc=";
    };
  };
  "tree-sitter-ca65" = {
  ...
  "tree-sitter-caddyfile" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "13ae3bac9983c41d8448cbb0cdcebc91b463a0f7";
      hash = "sha256-d+xwO3mmYzTU6+6hl85amtGuCsVXF7DMMyC5zygUOy4=";
    };
  };
  "tree-sitter-cairo" = {
    version = "1.0.0";
  ...
  "tree-sitter-catala_en" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ffae581fe12029132f64d82bd64ef49918ed9e79";
      hash = "sha256-pGuSE3Ex/SVYa2SueAH9tjtvMflSO71tmjt1BGG8HKk=";
    };
  };
  "tree-sitter-cds" = {
    version = "1.0.0";
  ...
  "tree-sitter-cmake" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.7.0";
      hash = "sha256-3gnaYMRC9t4jeIbduHQ/TZyIByM1D1DhmEtFk0xkYCw=";
    };
  };
  "tree-sitter-coalton" = {
  ...
  "tree-sitter-crystal" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f332617d66ef452552800c1a3a979a5826225570";
      hash = "sha256-f0/i9JHYWeif9xeZPKNacEnwcp6mPRRfFZ90I3lRgW8=";
    };
  };
  ...
  "tree-sitter-d2" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-d2";
      rev = "v0.6.0";
      hash = "sha256-h/h2f6YC6tYqE3Ql3HCaeBP+gJ/PhgIAiZjMCvPFO/Y=";
    };
  };
  "tree-sitter-dart" = {
  ...
  "tree-sitter-git_config" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-vbOfjn8iLXqyUywkVLl/1Bvy6nksEN4LsCmKLZ1ojds=";
    };
  };
  ...
  "tree-sitter-hcl" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-wROpwZQyjWw2ADVSyWQU4R4zcd+UJK/uz6LXdysH5E0=";
    };
  };
  "tree-sitter-heex" = {
    version = "0.8.0";
  ...
  "tree-sitter-lilypond" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "16447c0901f3512e659fbcd17ac864f11db49db0";
      hash = "sha256-xXN3RDzymv6Md+jsqy9xCClfyGlbODLtGzqpWq06cPA=";
    };
  };
  ...
  "tree-sitter-lispbm" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a9db6b6faf409b46d5f82a49d881045fc94bda7a";
      hash = "sha256-TU/QuS4pqEYqZWMOjAK0tLCePpPoGEv0ZsNt9LogKNw=";
    };
  };
  "tree-sitter-llvm" = {
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e58a7b9e940056ac0726413b8f1df93db3dcb532";
      hash = "sha256-52fZQC0siZhRJoqtiHFWXVWPO0u0goYNRPiX3rbhCMU=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "fdaa92565f5902afe81d958a48049f56721fd928";
      hash = "sha256-0Z8avFe7WHHUGbG8GYkNmxzztTNel/ih2lv/hRL1MbU=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "7153a024132dc7a4223599e5dbad2cac25ba307e";
      hash = "sha256-H04vv27XuXaW6+pahzcmmv0CBxKhF6zECgZiIhB3jTA=";
    };
  };
  ...
  "tree-sitter-ned" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "f18d2c7c0224ff868d8610367ed720147aa227e4";
      hash = "sha256-Hz7LIVKcxULI9OoJGvYJx4gBqTZRPGx9nJma/b1Dit8=";
    };
  };
  "tree-sitter-nelua" = {
    version = "unstable-2025-05-04";
    src = fetchFromGitHub {
      ...
      rev = "8d97cd8424602480a359fb222863f8cf13aada86";
      hash = "sha256-LwLdN2W/flAl6cOqze7r3B/PMDx35YJRZRXhhqKRetY=";
    };
  };
  "tree-sitter-nesfab" = {
  ...
  "tree-sitter-npf" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "22b6a926ae4077aee20d8d0ec7c780be1460e56c";
      hash = "sha256-SHsb0WsnnkfarVjWsK/n16DGgABFPft2xiJyVXQYPJk=";
    };
  };
  "tree-sitter-nqc" = {
    version = "1.0.0";
  ...
  "tree-sitter-octizys" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "9678740e95d8b2099505dfff124a7f487b38e768";
      hash = "sha256-+PghueR/RD/+KfdT7gyOxdXMrTqNjIfRoqzJX/i5nK4=";
    };
  };
  "tree-sitter-odin" = {
    version = "1.3.0";
  ...
  "tree-sitter-q" = {
    ...
    src = fetchFromGitHub {
      ...
      repo = "tree-sitter-q";
      rev = "v0.2.9";
      hash = "sha256-P4jmKSYw1gx0x95ru6+9y12bwehah2gaq3Py6XTom4I=";
    };
  };
  "tree-sitter-qbe" = {
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "a458a877aeb22430b3146e608960202400204da5";
      hash = "sha256-Kho9Jalm2KsdcxIHHNeDBauuJtx2YeSh5ia9uFU9v6s=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.5.8";
      hash = "sha256-b+JE0yc6ijIicqpSewgkLQAhSQb+XrOWfpG7wNTjugs=";
    };
  };
  ...
  "tree-sitter-tcl" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-J9mVVVgo92i9Pf2efa6XjopTi1XUxkpA5XiNHVDlQTI=";
    };
  };
  "tree-sitter-teal" = {
    version = "0.0.4";
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "92aae3bd37a9b55baf735ccdf51263cebfaf35d2";
      hash = "sha256-Ns6Upbjk6IljUoBOS1D0+BJFAr+MghTgujFxlErt31M=";
    };
  };
  "tree-sitter-tl" = {
  ...
  "tree-sitter-vhdl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.2.5";
      hash = "sha256-tMv2dJEkrJU2Y7OFVHSRlx4sdum4Hsb/rnHXNl4UJlc=";
    };
  };
  "tree-sitter-vhs" = {
    version = "unstable-2025-03-26";
  ...
  "tree-sitter-vola" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "2e59494a3ecb2554709b57ce1f3e05a1f108377d";
      hash = "sha256-lOzhl1h0jjKpFDZxvLXTH1/bVlahfUnCKioTcrvQiB8=";
    };
  };
  "tree-sitter-vrl" = {
    version = "0.1.1";
