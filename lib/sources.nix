{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-fram" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "37e1b680c04f37c653564612118876aada11da27";
      hash = "sha256-+Vm0Pzj5O3SbWuT09ODsOsXc+tSsHqPvseEzwN71iM8=";
    };
  };
  "tree-sitter-fsh" = {
    version = "unstable-2024-04-27";
  ...
  "tree-sitter-ned" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.0.6";
      hash = "sha256-fG8lcvrNNELgu3dm1PMO6krNvkhTzkAPujpWmJ/RuaA=";
    };
  };
  "tree-sitter-nelua" = {
    version = "unstable-2025-08-11";
