{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-chuck" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "04bf641bcaaa16ad1a17367b16468acf5d28b6f2";
      hash = "sha256-Rt7nUf5G4bpuBoL6XCuvLOJOBXINeUJbxHDIJSpS0aI=";
    };
  };
  "tree-sitter-circom" = {
  ...
  "tree-sitter-galvan" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "d7c84f812ee120670d0fb5f83b31e36c2253cb9a";
      hash = "sha256-gt5MnjUmvf9GYxLG2ILhXahqYbcscdLwgwcNHV/PrDs=";
    };
  };
  "tree-sitter-gap" = {
    version = "0.3.1";
  ...
  "tree-sitter-hygen_template" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.4.2";
      hash = "sha256-ZsO9B848acgOseP8+ZiTPTzR+w1RWotQO5R21IcFOZM=";
    };
  };
  "tree-sitter-hylo" = {
  ...
  "tree-sitter-jai" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "c2d618f078d8d11eb5ccc7764522da2dc4d1d179";
      hash = "sha256-JL57rdz+J5f94N+HxqiaRViZTaq3/60nQPw52w9po7Y=";
    };
  };
  "tree-sitter-jakt" = {
  ...
  "tree-sitter-javadoc" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.2.0";
      hash = "sha256-BDyCJRNx2PlAvHrf3+c13roVIHilQwjXsX+zt+2aWKY=";
    };
  };
  "tree-sitter-jelly" = {
    version = "0.1";
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "ea416df05f9db9ffe2f5088d5889c0eeaa75c935";
      hash = "sha256-6SLL2v0hccc3RgjUcjjgLtWbuF8JGEPducoWbvmzS+8=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "e3a100df8182b95988924ddc0c16af416bb7bfb0";
      hash = "sha256-1BTeQxr3vJ09e/t9JesmJ4SY4CtxT+lfAlPSRRPIggU=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "4d118b238787f61abdfc2313a95c515e31fd32be";
      hash = "sha256-6a04uvq7e4HG3dkmPxuQO6XUektqvY95UtUf9V40ro0=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-ned" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.0.4";
      hash = "sha256-Jz5vRB6ROA49ohITptUUN+HUAdINg7vtyeks0tl6Ha4=";
    };
  };
  "tree-sitter-nelua" = {
  ...
  "tree-sitter-pic" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "332fd7707319314f6dd1ced32666adb5230d4d85";
      hash = "sha256-DSwxQRVGAMroJN70qunske+VhKoGLW+URHyCM6PaL/Y=";
    };
  };
  "tree-sitter-pioasm" = {
  ...
  "tree-sitter-slint" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6ee7d053feabfff5d401491043a7286e30ffd7a8";
      hash = "sha256-I9vvmFsQKpqlfmJ7arrDcwj+1Rtwc+ZV8cPRAbmIzf8=";
    };
  };
  "tree-sitter-smali" = {
    version = "1.0.0";
  ...
  "tree-sitter-t32" = {
    ...
    src = fetchFromGitea {
      ...
      rev = "v5.5.2";
      hash = "sha256-b5GCCZNKvoQfE7syXipHXQQ3YTgh1VctrOrTQSezW4Q=";
    };
  };
