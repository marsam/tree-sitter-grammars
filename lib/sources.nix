{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-cfml" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.26.4";
      hash = "sha256-+uaRPi258Zt+YQzD7wzfRzzEUXlT6Rut8LitB0+FuXw=";
    };
  };
  "tree-sitter-cgsql" = {
  ...
  "tree-sitter-moonbit" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-xK+v+tc0XRbtYv9e9VNEFo2PITt/0WT2pANtZLerkpc=";
    };
  };
  "tree-sitter-mor" = {
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "869239c6d5f97c089d1f29901cd6ff466e5188de";
      hash = "sha256-MFnuAurBev4ikkNdqjay421OES6Eec62yn/bk2Ifozo=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.11";
