{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-caddyfile" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "18af4bae6028bc5a7b620b3ab5a537b243aec9f7";
      hash = "sha256-JHnNsKwt9p+MOyopheNdW/voArbDllp63AgcTMX3WxY=";
    };
  };
  "tree-sitter-cairo" = {
    version = "1.0.0";
  ...
  "tree-sitter-clingo" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v1.0.0";
      hash = "sha256-ZRDxZzE7oUDWi3las/3w7YyiOw0s4pTqosZKA9j9xrE=";
    };
  };
  "tree-sitter-clojure" = {
    version = "0.0.13";
  ...
  "tree-sitter-enforce" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "v0.3.0";
      hash = "sha256-hJI3mDWH/Kb6R4iJM6XG1n13Q8m84MWcNPox9qaceTg=";
    };
  };
  "tree-sitter-envy" = {
  ...
  "tree-sitter-fodot" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "10f926be9ec66b9930b458226b0ccdaac35f69f2";
      hash = "sha256-hLK1CFNrGnm2LQ/fU0rD2392xsBPGgQqjFViPrE14xc=";
    };
  };
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "32ee1f6d4a4d1a4af17cbdc5e1f226764dad754a";
      hash = "sha256-Qq6jdOXLVHyr0HfrTXaG0PIAWVa8XcW+/gQ/wuvwhQU=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-spicy" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "600e64b8dea0772bae35283b4ee6a33b633f5af4";
      hash = "sha256-TVMss6ff4BKgdTNP+DNGDCUwL/Z8kzEaegxDqUP2zoA=";
    };
  };
  "tree-sitter-spml" = {
    version = "0.0.1";
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.9.25";
      hash = "sha256-jWodj3tpQ1aRYMvI1HUSu5ilaqwaUc3orrGDXUmsUlY=";
    };
  };
  ...
  "tree-sitter-times" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "70be3879b72c550a5271d2854deabc4a9b57d8dd";
      hash = "sha256-YT649PBNwBLvMelCMrE/8PwgmLAc09CZM97IUzescVg=";
    };
  };
  "tree-sitter-tl" = {
