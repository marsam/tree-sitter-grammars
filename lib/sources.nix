{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-erlang" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "81989eb3b1f067367a8b655263c41081f34be7d9";
      hash = "sha256-xFlbKDPttbyQ0w8Ko38Hvq3sKWZGL4WjmC4TaXV0A80=";
    };
  };
  "tree-sitter-esdl" = {
  ...
  "tree-sitter-koto" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "4d1b37bd19f27b797dbc1d5544db193feabd24ed";
      hash = "sha256-GPzhplIyBU4fJvd/9Yu48bB9rkVdEeHFeLCgUsJ81/U=";
    };
  };
  "tree-sitter-kusto" = {
    version = "unstable-2023-11-03";
  ...
  "tree-sitter-magik" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1842e770b8f4ee757a4fa669301279873970cc8c";
      hash = "sha256-7W9+9/oiXd1ENzPSRCqCndoFEAKapvKdCFq0EKJ/IjQ=";
    };
  };
  "tree-sitter-make" = {
    version = "1.1.1";
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-/2ZnclwWpVTPayFfhk4C7lbQNhbc9xOng5PgW/HZ6vY=";
    };
  };
  "tree-sitter-mojo" = {
    version = "unstable-2024-12-07";
  ...
  "tree-sitter-tcl" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "85a6e11649ae86a28153de8b672333b2cda79e53";
      hash = "sha256-q9xw3htcKizJpDszs9LRT5I64HHe/Fs16WxKHNd4w4U=";
    };
  };
  "tree-sitter-teal" = {
    version = "0.0.4";
