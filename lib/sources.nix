{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-fodot" = {
    ...
    src = fetchFromGitLab {
      ...
      rev = "c1b5ce0bb8f3d523cc6ffad4a779b2b9bb6a6ffe";
      hash = "sha256-6//dELvSTKmV+niHxspGoK6XYYyp879ly0t7w+yfhEc=";
    };
  };
  ...
  "tree-sitter-ssh_client_config" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "2025.7.24";
      hash = "sha256-eTU54QFvEKXi4GTI3FXk99T5po2VIPFAytEXIzlmgiA=";
    };
  };
