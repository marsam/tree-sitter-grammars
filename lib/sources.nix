{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-amber" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "dc69f42449fd3c807bacefa398263f62e581f755";
      hash = "sha256-PqEqaye/RmGCmNnJaq2zboMaOvpa/8CmuFz6pBav5Qs=";
    };
  };
  "tree-sitter-angular" = {
    version = "0.8.0";
  ...
  "tree-sitter-gram" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "0.2.3";
      hash = "sha256-krKbsWhLZWh83WVlOaGa5vj4LDW+87aLsHMXRIO/PbU=";
    };
  };
  "tree-sitter-graphql" = {
