{ fetchFromGitHub, fetchFromGitLab, fetchFromGitea }:
{
  ...
  "tree-sitter-mlir" = {
    ...
    src = fetchFromGitHub {
      ...
      hash = "sha256-WOcdhnofUQ9wckmEJ3C/bxZy6MUvEoCNm/X3r+LtmH8=";
    };
  };
  "tree-sitter-mojo" = {
  ...
  "tree-sitter-pyrope" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "6481bb3684c4804737f2f6ecda617acfc17343e0";
      hash = "sha256-RKwiZbViZ2f6rF/S8Bahff7547MMhtGJIgs8DFedKCA=";
    };
  };
  "tree-sitter-q" = {
    version = "0.2.11";
  ...
  "tree-sitter-rescript" = {
    ...
    src = fetchFromGitHub {
      ...
      rev = "1e04f060687bc8f28610089d9a247622903ca260";
      hash = "sha256-1+XKD6zQI7LbtUbP59q0Hc/ae6ciF1FoSEm3PtUvjKY=";
    };
  };
