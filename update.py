...
GRAMMARS: dict[str, Grammar] = {
    ...
    "tree-sitter-aria": Grammar("https://github.com/arialang/tree-sitter-aria"),
    ...
    "tree-sitter-astra": Grammar("https://github.com/naidaon/tree-sitter-astra", None, "0.1.0"),  # not versioned
    "tree-sitter-astro": Grammar("https://github.com/virchau13/tree-sitter-astro"),
    "tree-sitter-august": Grammar("https://github.com/HaydenAtFoxHaven/tree-sitter-august"),
    ...
    "tree-sitter-bpf_c": Grammar("https://github.com/d-e-s-o/tree-sitter-bpf-c"),
    "tree-sitter-bpftrace": Grammar("https://github.com/sgruszka/tree-sitter-bpftrace"),
    ...
    "tree-sitter-caddyfile": Grammar("https://github.com/caddyserver/tree-sitter-caddyfile"),
    ...
    "tree-sitter-cangjie": Grammar("https://github.com/jstzwj/tree-sitter-cangjie"),  # Alternative: https://github.com/Cangjie-Pub/tree-sitter-cangjie https://gitcode.com/Cangjie-SIG/tree-sitter-cangjie
    ...
    "tree-sitter-cedar": Grammar("https://github.com/DuskSystems/tree-sitter-cedar"),
    ...
    "tree-sitter-concerto": Grammar("https://github.com/accordproject/concerto-tree-sitter"),
    ...
    "tree-sitter-csound": Grammar("https://github.com/PasqualeMainolfi/tree-sitter-csound"),
    ...
    "tree-sitter-diff": Grammar("https://github.com/tree-sitter-grammars/tree-sitter-diff"),
    "tree-sitter-disassembly": Grammar("https://github.com/ColinKennedy/tree-sitter-disassembly"),
    "tree-sitter-djot": Grammar("https://codeberg.org/treeman/tree-sitter-djot"),
    ...
    "tree-sitter-dotenv": Grammar("https://github.com/zarifpour/tree-sitter-dotenv"), # Alternative: https://github.com/pnx/tree-sitter-dotenv
    ...
    "tree-sitter-elle": Grammar("https://github.com/acquitelol/tree-sitter-elle"),
    ...
    "tree-sitter-epics_cmd": Grammar("https://github.com/minijackson/tree-sitter-epics-cmd"),
    "tree-sitter-epics_db": Grammar("https://github.com/minijackson/tree-sitter-epics-db"),
    "tree-sitter-epics_msi_substitution": Grammar("https://github.com/minijackson/tree-sitter-epics-msi-substitution"),
    "tree-sitter-epics_msi_template": Grammar("https://github.com/minijackson/tree-sitter-epics-msi-template"),
    ...
    "tree-sitter-expando": Grammar("https://github.com/neomutt/tree-sitter-expando"),
    ...
    "tree-sitter-fram": Grammar("https://github.com/fram-lang/tree-sitter-fram"),
    ...
    "tree-sitter-gdshader": Grammar("https://github.com/airblast-dev/tree-sitter-gdshader"),
    ...
    "tree-sitter-gherkin": Grammar("https://github.com/binhtddev/tree-sitter-gherkin"),
    ...
    "tree-sitter-gowork": Grammar("https://github.com/zed-industries/tree-sitter-go-work"),
    ...
    "tree-sitter-gren": Grammar("https://github.com/gren-lang/tree-sitter-gren"),
    ...
    "tree-sitter-haxe": Grammar("https://github.com/vantreeseba/tree-sitter-haxe"),  # Alternative: https://github.com/tong/tree-sitter-haxe
    ...
    "tree-sitter-horn": Grammar("https://github.com/giannos-ch/tree-sitter-horn"),
    ...
    "tree-sitter-hxml": Grammar("https://github.com/tong/tree-sitter-hxml"),
    ...
    "tree-sitter-ink": Grammar("https://github.com/wldmr/tree-sitter-ink"),  # Alternative: https://github.com/little-bonsai/tree-sitter-ink
    ...
    "tree-sitter-julia": Grammar("https://github.com/tree-sitter-grammars/tree-sitter-julia"),
    "tree-sitter-just": Grammar("https://github.com/casey/tree-sitter-just"),
    ...
    "tree-sitter-kanshi": Grammar("https://github.com/marcelmanz/tree-sitter-kanshi"),
    ...
    "tree-sitter-lean": Grammar("https://github.com/Julian/tree-sitter-lean"),  # Alternative https://github.com/estradilua/tree-sitter-lean
    ...
    "tree-sitter-lilypond": Grammar("https://github.com/nwhetsell/tree-sitter-lilypond"),
    ...
    "tree-sitter-morloc": Grammar("https://github.com/morloc-project/tree-sitter-morloc"),
    ...
    "tree-sitter-nur": Grammar("https://github.com/alkhizanah/tree-sitter-nur"),
    ...
    "tree-sitter-objectscript": Grammar("https://github.com/intersystems/tree-sitter-objectscript"),
    ...
    "tree-sitter-orca": Grammar("https://github.com/kszenes/tree-sitter-orca"),
    "tree-sitter-org": Grammar("https://github.com/nvim-orgmode/tree-sitter-org"),
    "tree-sitter-ott": Grammar("https://github.com/arawho/tree-sitter-ott"),
    "tree-sitter-p4": Grammar("https://github.com/oxidecomputer/tree-sitter-p4"),
    "tree-sitter-pactum": Grammar("https://github.com/protopact/tree-sitter-pactum"),
    ...
    "tree-sitter-perl": Grammar("https://github.com/tree-sitter-perl/tree-sitter-perl"),
    ...
    "tree-sitter-piglet": Grammar("https://github.com/piglet-lang/tree-sitter-piglet"),
    ...
    "tree-sitter-pluto": Grammar("https://github.com/asumbek/tree-sitter-pluto"),
    ...
    "tree-sitter-pod": Grammar("https://github.com/tree-sitter-perl/tree-sitter-pod"),
    ...
    "tree-sitter-qbe": Grammar("https://github.com/bitterbloom/tree-sitter-qbe", "HEAD"),
    ...
    "tree-sitter-refal": Grammar("https://github.com/ilya-klyuchnikov/tree-sitter-refal"),
    ...
    "tree-sitter-rescript": Grammar("https://github.com/rescript-lang/tree-sitter-rescript"),
    "tree-sitter-restedlang": Grammar("https://github.com/Gnarus-G/tree-sitter-restedlang"),
    "tree-sitter-rifleconf": Grammar("https://github.com/purarue/tree-sitter-rifleconf"),
    ...
    "tree-sitter-rshtml": Grammar("https://github.com/rshtml/tree-sitter-rshtml"),
    ...
    "tree-sitter-snl": Grammar("https://github.com/minijackson/tree-sitter-snl"),
    ...
    "tree-sitter-streamdevice_proto": Grammar("https://github.com/minijackson/tree-sitter-streamdevice-proto"),
    ...
    "tree-sitter-surrealql": Grammar("https://github.com/surrealdb/surrealql-tree-sitter"),
    ...
    "tree-sitter-teal": Grammar("https://github.com/euclidianAce/tree-sitter-teal"),  # Alternative: https://github.com/0komo/tree-sitter-teal
    ...
    "tree-sitter-tmuxf": Grammar("https://github.com/Freed-Wu/tree-sitter-tmuxf"),
    ...
    "tree-sitter-twig": Grammar("https://github.com/gbprod/tree-sitter-twig"),  # Alternative: https://github.com/kaermorchen/tree-sitter-twig
    ...
    "tree-sitter-vcl": Grammar("https://github.com/ntsk/tree-sitter-vcl"),
    ...
    "tree-sitter-veryl": Grammar("https://github.com/veryl-lang/tree-sitter-veryl"),
    ...
    "tree-sitter-wgsl": Grammar("https://github.com/szebniok/tree-sitter-wgsl"),  # Alternative: https://github.com/gpuweb/tree-sitter-wgsl https://github.com/include-yy/tree-sitter-wgsl
    ...
    "tree-sitter-wikitext": Grammar("https://github.com/wikimedia/tree-sitter-wikitext"),
    ...
    "tree-sitter-wxml": Grammar("https://github.com/BlockLune/tree-sitter-wxml"),
    ...
    "tree-sitter-zsh": Grammar("https://github.com/georgeharker/tree-sitter-zsh"),
