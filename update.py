...
GRAMMARS: dict[str, Grammar] = {
    ...
    "tree-sitter-embedded-template": Grammar("https://github.com/tree-sitter/tree-sitter-embedded-template"),
    ...
    "tree-sitter-ql-dbscheme": Grammar("https://github.com/tree-sitter/tree-sitter-ql-dbscheme"),
    ...
    "tree-sitter-aidl": Grammar("https://github.com/AndroidIDEOfficial/tree-sitter-aidl"),
    ...
    "tree-sitter-aotcl": Grammar("https://github.com/NexushasTaken/tree-sitter-aotcl"),
    ...
    "tree-sitter-bsv": Grammar("https://github.com/yuyuranium/tree-sitter-bsv"),
    ...
    "tree-sitter-cerium": Grammar("https://github.com/cerium-lang/tree-sitter-cerium"),
    ...
    "tree-sitter-cicada": Grammar("https://github.com/Cicada-Software/tree-sitter-cicada"),
    ...
    "tree-sitter-convex-lisp": Grammar("https://github.com/crimeminister/tree-sitter-convex-lisp"),
    ...
    "tree-sitter-css-in-js": Grammar("https://github.com/orzechowskid/tree-sitter-css-in-js", "HEAD"),
    ...
    "tree-sitter-darklang": Grammar("https://github.com/darklang/dark"),
    "tree-sitter-dart": Grammar("https://github.com/UserNobody14/tree-sitter-dart"),
    "tree-sitter-datazinc": Grammar("https://github.com/shackle-rs/shackle"),
    ...
    "tree-sitter-ditto": Grammar("https://github.com/ditto-lang/tree-sitter-ditto"),
    ...
    "tree-sitter-epics-cmd": Grammar("https://github.com/epics-extensions/tree-sitter-epics"),
    ...
    "tree-sitter-format-string": Grammar("https://github.com/ValdezFOmar/tree-sitter-format-string"),
    ...
    "tree-sitter-git-commit": Grammar("https://github.com/the-mikedavis/tree-sitter-git-commit"),
    "tree-sitter-git-config": Grammar("https://github.com/the-mikedavis/tree-sitter-git-config"),
    "tree-sitter-git-merge-conflict": Grammar("https://github.com/pv-hernandez/tree-sitter-git-merge-conflict"),
    "tree-sitter-git-rebase": Grammar("https://github.com/the-mikedavis/tree-sitter-git-rebase"),
    ...
    "tree-sitter-glimmer-javascript": Grammar("https://github.com/NullVoxPopuli/tree-sitter-glimmer-javascript"),
    "tree-sitter-glimmer-typescript": Grammar("https://github.com/NullVoxPopuli/tree-sitter-glimmer-typescript"),
    ...
    "tree-sitter-go-work": Grammar("https://github.com/d1y/tree-sitter-go-work"),
    ...
    "tree-sitter-godot-resource": Grammar("https://github.com/PrestonKnopp/tree-sitter-godot-resource"),
    ...
    "tree-sitter-gowork": Grammar("https://github.com/omertuc/tree-sitter-go-work"),
    ...
    "tree-sitter-haskell-persistent": Grammar("https://github.com/MercuryTechnologies/tree-sitter-haskell-persistent"),
    ...
    "tree-sitter-hygen-template": Grammar("https://github.com/Hdoc1509/tree-sitter-hygen-template"),
    ...
    "tree-sitter-i3config": Grammar("https://github.com/abdellatif-temsamani/tree-sitter-i3config"),
    ...
    "tree-sitter-janet-simple": Grammar("https://github.com/sogaiu/tree-sitter-janet-simple"),
    ...
    "tree-sitter-kitty-conf": Grammar("https://github.com/clo4/tree-sitter-kitty-conf"),
    "tree-sitter-koka": Grammar("https://github.com/mtoohey31/tree-sitter-koka"),
    # "tree-sitter-kon": Grammar("https://github.com/akonwi/tree-sitter-kon"),  # Removed?
    ...
    "tree-sitter-lilypond-scheme": Grammar("https://github.com/nwhetsell/tree-sitter-lilypond-scheme"),
    ...
    "tree-sitter-llvm-mir": Grammar("https://github.com/Flakebi/tree-sitter-llvm-mir"),
    ...
    "tree-sitter-man-db-config": Grammar("https://github.com/TornaxO7/tree-sitter-man-db-config", None, "0.1.0"), # Not versioned
    ...
    "tree-sitter-move-on-aptos": Grammar("https://github.com/aptos-labs/tree-sitter-move-on-aptos"),
    ...
    "tree-sitter-navi-stream": Grammar("https://github.com/navi-language/tree-sitter-navi-stream"),
    ...
    "tree-sitter-nim-format-string": Grammar("https://github.com/aMOPel/tree-sitter-nim-format-string"),
    ...
    "tree-sitter-owl-ms": Grammar("https://github.com/janekx21/tree-sitter-owl-ms"),
    ...
    "tree-sitter-plymouth-script": Grammar("https://github.com/liushuyu/tree-sitter-plymouth-script"),
    ...
    "tree-sitter-poe-filter": Grammar("https://github.com/tree-sitter-grammars/tree-sitter-poe-filter"),
    ...
    "tree-sitter-proto": Grammar("https://github.com/treywood/tree-sitter-proto"),
    ...
    "tree-sitter-river": Grammar("https://github.com/grafana/tree-sitter-river"),
    ...
    "tree-sitter-scss": Grammar("https://github.com/serenadeai/tree-sitter-scss"),
    ...
    "tree-sitter-sml": Grammar("https://github.com/MatthewFluet/tree-sitter-sml"),
    ...
    "tree-sitter-sql-bigquery": Grammar("https://github.com/takegue/tree-sitter-sql-bigquery"),
    "tree-sitter-squirrel": Grammar("https://github.com/tree-sitter-grammars/tree-sitter-squirrel"),
    "tree-sitter-ssh-client-config": Grammar("https://github.com/metio/tree-sitter-ssh-client-config", ("tag", "2025.1.9")),  # FIXME(marsam): later versions yield different hash on Darwin
    "tree-sitter-ssh-config": Grammar("https://github.com/tree-sitter-grammars/tree-sitter-ssh-config"),
    ...
    # "tree-sitter-structured-text": Grammar("https://github.com/retrofit-st/tree-sitter-structured-text"), # Removed?
    ...
    "tree-sitter-sus": Grammar("https://github.com/pc2/sus-compiler", "HEAD"),
    ...
    "tree-sitter-swift": Grammar("https://github.com/alex-pinkus/tree-sitter-swift", "HEAD"),
    "tree-sitter-sxhkdrc": Grammar("https://github.com/RaafatTurki/tree-sitter-sxhkdrc"),
    "tree-sitter-syncat-stylesheet": Grammar("https://github.com/foxfriends/syncat"),
    ...
    "tree-sitter-v": Grammar("https://github.com/vlang/v-analyzer", "HEAD"),
    ...
    "tree-sitter-wgsl-bevy": Grammar("https://github.com/tree-sitter-grammars/tree-sitter-wgsl-bevy"),
